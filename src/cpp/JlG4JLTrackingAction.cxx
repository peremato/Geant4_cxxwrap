...
struct JlG4JLTrackingAction: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.constructor<trackaction_f>(/*finalize=*/jlcxx::finalize_policy::yes);
    t.constructor<trackaction_f, void *>(/*finalize=*/jlcxx::finalize_policy::yes);
    t.constructor<trackaction_f, void *, trackaction_f>(/*finalize=*/jlcxx::finalize_policy::yes);
    t.constructor<trackaction_f, void *, trackaction_f, void *>(/*finalize=*/jlcxx::finalize_policy::yes);
