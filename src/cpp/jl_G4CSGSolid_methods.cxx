...
void add_methods_for_G4CSGSolid(jlcxx::Module& types, jlcxx::TypeWrapper<G4CSGSolid>& t152) {
  ...
  t152.method("GetPolyhedron", static_cast<G4Polyhedron * (G4CSGSolid::*)()  const>(&G4CSGSolid::GetPolyhedron));
  ...
  t152.method("assign", static_cast<G4CSGSolid & (G4CSGSolid::*)(const G4CSGSolid &) >(&G4CSGSolid::operator=));
