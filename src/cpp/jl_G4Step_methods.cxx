...
void add_methods_for_G4Step(jlcxx::Module& types, jlcxx::TypeWrapper<G4Step>& t57) {
  ...
  t57.constructor<const G4Step &>(/*finalize=*/true);
  ...
  t57.method("assign", static_cast<G4Step & (G4Step::*)(const G4Step &) >(&G4Step::operator=));
  ...
  t57.method("GetTrack", static_cast<G4Track * (G4Step::*)()  const>(&G4Step::GetTrack));
  ...
  t57.method("SetTrack", static_cast<void (G4Step::*)(G4Track *) >(&G4Step::SetTrack));
  ...
  t57.method("GetPreStepPoint", static_cast<G4StepPoint * (G4Step::*)()  const>(&G4Step::GetPreStepPoint));
  ...
  t57.method("SetPreStepPoint", static_cast<void (G4Step::*)(G4StepPoint *) >(&G4Step::SetPreStepPoint));
  ...
  t57.method("ResetPreStepPoint", static_cast<G4StepPoint * (G4Step::*)(G4StepPoint *) >(&G4Step::ResetPreStepPoint));
  t57.method("ResetPreStepPoint", [](G4Step& a)->G4StepPoint *{ return a.ResetPreStepPoint(); });
  t57.method("ResetPreStepPoint", [](G4Step* a)->G4StepPoint *{ return a->ResetPreStepPoint(); });
  ...
  t57.method("GetPostStepPoint", static_cast<G4StepPoint * (G4Step::*)()  const>(&G4Step::GetPostStepPoint));
  ...
  t57.method("SetPostStepPoint", static_cast<void (G4Step::*)(G4StepPoint *) >(&G4Step::SetPostStepPoint));
  ...
  t57.method("ResetPostStepPoint", static_cast<G4StepPoint * (G4Step::*)(G4StepPoint *) >(&G4Step::ResetPostStepPoint));
  t57.method("ResetPostStepPoint", [](G4Step& a)->G4StepPoint *{ return a.ResetPostStepPoint(); });
  t57.method("ResetPostStepPoint", [](G4Step* a)->G4StepPoint *{ return a->ResetPostStepPoint(); });
  ...
  t57.method("GetStepLength", static_cast<G4double (G4Step::*)()  const>(&G4Step::GetStepLength));
  ...
  t57.method("SetStepLength", static_cast<void (G4Step::*)(G4double) >(&G4Step::SetStepLength));
  ...
  t57.method("GetTotalEnergyDeposit", static_cast<G4double (G4Step::*)()  const>(&G4Step::GetTotalEnergyDeposit));
  ...
  t57.method("SetTotalEnergyDeposit", static_cast<void (G4Step::*)(G4double) >(&G4Step::SetTotalEnergyDeposit));
  ...
  t57.method("GetNonIonizingEnergyDeposit", static_cast<G4double (G4Step::*)()  const>(&G4Step::GetNonIonizingEnergyDeposit));
  ...
  t57.method("SetNonIonizingEnergyDeposit", static_cast<void (G4Step::*)(G4double) >(&G4Step::SetNonIonizingEnergyDeposit));
  ...
  t57.method("GetControlFlag", static_cast<G4SteppingControl (G4Step::*)()  const>(&G4Step::GetControlFlag));
  ...
  t57.method("SetControlFlag", static_cast<void (G4Step::*)(G4SteppingControl) >(&G4Step::SetControlFlag));
  ...
  t57.method("AddTotalEnergyDeposit", static_cast<void (G4Step::*)(G4double) >(&G4Step::AddTotalEnergyDeposit));
  ...
  t57.method("ResetTotalEnergyDeposit", static_cast<void (G4Step::*)() >(&G4Step::ResetTotalEnergyDeposit));
  ...
  t57.method("AddNonIonizingEnergyDeposit", static_cast<void (G4Step::*)(G4double) >(&G4Step::AddNonIonizingEnergyDeposit));
  ...
  t57.method("ResetNonIonizingEnergyDeposit", static_cast<void (G4Step::*)() >(&G4Step::ResetNonIonizingEnergyDeposit));
  ...
  t57.method("IsFirstStepInVolume", static_cast<G4bool (G4Step::*)()  const>(&G4Step::IsFirstStepInVolume));
  ...
  t57.method("IsLastStepInVolume", static_cast<G4bool (G4Step::*)()  const>(&G4Step::IsLastStepInVolume));
  ...
  t57.method("SetFirstStepFlag", static_cast<void (G4Step::*)() >(&G4Step::SetFirstStepFlag));
  ...
  t57.method("ClearFirstStepFlag", static_cast<void (G4Step::*)() >(&G4Step::ClearFirstStepFlag));
  ...
  t57.method("SetLastStepFlag", static_cast<void (G4Step::*)() >(&G4Step::SetLastStepFlag));
  ...
  t57.method("ClearLastStepFlag", static_cast<void (G4Step::*)() >(&G4Step::ClearLastStepFlag));
  ...
  t57.method("GetDeltaPosition", static_cast<G4ThreeVector (G4Step::*)()  const>(&G4Step::GetDeltaPosition));
  ...
  t57.method("GetDeltaTime", static_cast<G4double (G4Step::*)()  const>(&G4Step::GetDeltaTime));
  ...
  t57.method("GetDeltaMomentum", static_cast<G4ThreeVector (G4Step::*)()  const>(&G4Step::GetDeltaMomentum));
  ...
  t57.method("GetDeltaEnergy", static_cast<G4double (G4Step::*)()  const>(&G4Step::GetDeltaEnergy));
  ...
  t57.method("InitializeStep", static_cast<void (G4Step::*)(G4Track *) >(&G4Step::InitializeStep));
  ...
  t57.method("UpdateTrack", static_cast<void (G4Step::*)() >(&G4Step::UpdateTrack));
  ...
  t57.method("CopyPostToPreStepPoint", static_cast<void (G4Step::*)() >(&G4Step::CopyPostToPreStepPoint));
  ...
  t57.method("SetPointerToVectorOfAuxiliaryPoints", static_cast<void (G4Step::*)(std::vector<G4ThreeVector> *) >(&G4Step::SetPointerToVectorOfAuxiliaryPoints));
  ...
  t57.method("GetPointerToVectorOfAuxiliaryPoints", static_cast<std::vector<G4ThreeVector> * (G4Step::*)()  const>(&G4Step::GetPointerToVectorOfAuxiliaryPoints));
  ...
  t57.method("GetNumberOfSecondariesInCurrentStep", static_cast<size_t (G4Step::*)()  const>(&G4Step::GetNumberOfSecondariesInCurrentStep));
  ...
  t57.method("GetSecondary", static_cast<const G4TrackVector * (G4Step::*)()  const>(&G4Step::GetSecondary));
  ...
  t57.method("GetfSecondary", static_cast<G4TrackVector * (G4Step::*)() >(&G4Step::GetfSecondary));
  ...
  t57.method("NewSecondaryVector", static_cast<G4TrackVector * (G4Step::*)() >(&G4Step::NewSecondaryVector));
  ...
  t57.method("DeleteSecondaryVector", static_cast<void (G4Step::*)() >(&G4Step::DeleteSecondaryVector));
  ...
  t57.method("SetSecondary", static_cast<void (G4Step::*)(G4TrackVector *) >(&G4Step::SetSecondary));
