...
void add_methods_for_G4Torus(jlcxx::Module& types, jlcxx::TypeWrapper<G4Torus>& t192) {
  ...
  t192.constructor<const G4String &, G4double, G4double, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t192.method("GetRmin", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetRmin));
  ...
  t192.method("GetRmax", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetRmax));
  ...
  t192.method("GetRtor", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetRtor));
  ...
  t192.method("GetSPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetSPhi));
  ...
  t192.method("GetDPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetDPhi));
  ...
  t192.method("GetSinStartPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetSinStartPhi));
  ...
  t192.method("GetCosStartPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetCosStartPhi));
  ...
  t192.method("GetSinEndPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetSinEndPhi));
  ...
  t192.method("GetCosEndPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetCosEndPhi));
  ...
  t192.method("GetCubicVolume", static_cast<G4double (G4Torus::*)() >(&G4Torus::GetCubicVolume));
  ...
  t192.method("GetSurfaceArea", static_cast<G4double (G4Torus::*)() >(&G4Torus::GetSurfaceArea));
  ...
  t192.method("Inside", static_cast<EInside (G4Torus::*)(const G4ThreeVector &)  const>(&G4Torus::Inside));
  ...
  t192.method("BoundingLimits", static_cast<void (G4Torus::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Torus::BoundingLimits));
  ...
  t192.method("ComputeDimensions", static_cast<void (G4Torus::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4Torus::ComputeDimensions));
  ...
  t192.method("SurfaceNormal", static_cast<G4ThreeVector (G4Torus::*)(const G4ThreeVector &)  const>(&G4Torus::SurfaceNormal));
  ...
  t192.method("DistanceToIn", static_cast<G4double (G4Torus::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Torus::DistanceToIn));
  ...
  t192.method("DistanceToIn", static_cast<G4double (G4Torus::*)(const G4ThreeVector &)  const>(&G4Torus::DistanceToIn));
  ...
  t192.method("DistanceToOut", static_cast<G4double (G4Torus::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Torus::DistanceToOut));
  t192.method("DistanceToOut", [](G4Torus const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t192.method("DistanceToOut", [](G4Torus const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t192.method("DistanceToOut", [](G4Torus const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t192.method("DistanceToOut", [](G4Torus const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t192.method("DistanceToOut", [](G4Torus const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t192.method("DistanceToOut", [](G4Torus const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t192.method("DistanceToOut", static_cast<G4double (G4Torus::*)(const G4ThreeVector &)  const>(&G4Torus::DistanceToOut));
  ...
  t192.method("GetEntityType", static_cast<G4GeometryType (G4Torus::*)()  const>(&G4Torus::GetEntityType));
  ...
  t192.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Torus::*)()  const>(&G4Torus::GetPointOnSurface));
  ...
  t192.method("Clone", static_cast<G4VSolid * (G4Torus::*)()  const>(&G4Torus::Clone));
  ...
  t192.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Torus::*)()  const>(&G4Torus::CreatePolyhedron));
  ...
  t192.method("SetAllParameters", static_cast<void (G4Torus::*)(G4double, G4double, G4double, G4double, G4double) >(&G4Torus::SetAllParameters));
  ...
  t192.constructor<const G4Torus &>(/*finalize=*/true);
  ...
  t192.method("assign", static_cast<G4Torus & (G4Torus::*)(const G4Torus &) >(&G4Torus::operator=));
