...
void add_methods_for_G4Torus(jlcxx::Module& types, jlcxx::TypeWrapper<G4Torus>& t185) {
  ...
  t185.constructor<const G4String &, G4double, G4double, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t185.method("GetRmin", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetRmin));
  ...
  t185.method("GetRmax", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetRmax));
  ...
  t185.method("GetRtor", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetRtor));
  ...
  t185.method("GetSPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetSPhi));
  ...
  t185.method("GetDPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetDPhi));
  ...
  t185.method("GetSinStartPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetSinStartPhi));
  ...
  t185.method("GetCosStartPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetCosStartPhi));
  ...
  t185.method("GetSinEndPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetSinEndPhi));
  ...
  t185.method("GetCosEndPhi", static_cast<G4double (G4Torus::*)()  const>(&G4Torus::GetCosEndPhi));
  ...
  t185.method("GetCubicVolume", static_cast<G4double (G4Torus::*)() >(&G4Torus::GetCubicVolume));
  ...
  t185.method("GetSurfaceArea", static_cast<G4double (G4Torus::*)() >(&G4Torus::GetSurfaceArea));
  ...
  t185.method("Inside", static_cast<EInside (G4Torus::*)(const G4ThreeVector &)  const>(&G4Torus::Inside));
  ...
  t185.method("BoundingLimits", static_cast<void (G4Torus::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Torus::BoundingLimits));
  ...
  t185.method("ComputeDimensions", static_cast<void (G4Torus::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4Torus::ComputeDimensions));
  ...
  t185.method("SurfaceNormal", static_cast<G4ThreeVector (G4Torus::*)(const G4ThreeVector &)  const>(&G4Torus::SurfaceNormal));
  ...
  t185.method("DistanceToIn", static_cast<G4double (G4Torus::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Torus::DistanceToIn));
  ...
  t185.method("DistanceToIn", static_cast<G4double (G4Torus::*)(const G4ThreeVector &)  const>(&G4Torus::DistanceToIn));
  ...
  t185.method("DistanceToOut", static_cast<G4double (G4Torus::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Torus::DistanceToOut));
  t185.method("DistanceToOut", [](G4Torus const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t185.method("DistanceToOut", [](G4Torus const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t185.method("DistanceToOut", [](G4Torus const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t185.method("DistanceToOut", [](G4Torus const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t185.method("DistanceToOut", [](G4Torus const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t185.method("DistanceToOut", [](G4Torus const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t185.method("DistanceToOut", static_cast<G4double (G4Torus::*)(const G4ThreeVector &)  const>(&G4Torus::DistanceToOut));
  ...
  t185.method("GetEntityType", static_cast<G4GeometryType (G4Torus::*)()  const>(&G4Torus::GetEntityType));
  ...
  t185.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Torus::*)()  const>(&G4Torus::GetPointOnSurface));
  ...
  t185.method("Clone", static_cast<G4VSolid * (G4Torus::*)()  const>(&G4Torus::Clone));
  ...
  t185.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Torus::*)()  const>(&G4Torus::CreatePolyhedron));
  ...
  t185.method("SetAllParameters", static_cast<void (G4Torus::*)(G4double, G4double, G4double, G4double, G4double) >(&G4Torus::SetAllParameters));
  ...
  t185.constructor<const G4Torus &>(/*finalize=*/true);
  ...
  t185.method("assign", static_cast<G4Torus & (G4Torus::*)(const G4Torus &) >(&G4Torus::operator=));
