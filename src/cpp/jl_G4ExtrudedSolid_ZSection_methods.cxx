...
void add_methods_for_G4ExtrudedSolid_ZSection(jlcxx::Module& types, jlcxx::TypeWrapper<G4ExtrudedSolid::ZSection>& t161) {
  ...
  t161.constructor<G4double, const G4TwoVector &, G4double>(/*finalize=*/true);
  ...
  t161.method("fZ", [](const G4ExtrudedSolid::ZSection& a) -> G4double { return a.fZ; });
  t161.method("fZ", [](G4ExtrudedSolid::ZSection& a) -> G4double { return a.fZ; });
  t161.method("fZ", [](const G4ExtrudedSolid::ZSection* a) -> G4double { return a->fZ; });
  t161.method("fZ", [](G4ExtrudedSolid::ZSection* a) -> G4double { return a->fZ; });
  // defined in /Users/mato/.julia/artifacts/9d4b417a98ec8f720b8871baefe87108f864656f/include/Geant4/G4ExtrudedSolid.hh:82:19
  // signature to use in the veto list: G4ExtrudedSolid::ZSection::fZ
  ...
  t161.method("fZ!", [](G4ExtrudedSolid::ZSection& a, G4double val) -> G4double { return a.fZ = val; });
  ...
  t161.method("fOffset", [](const G4ExtrudedSolid::ZSection& a) -> const G4TwoVector& { return a.fOffset; });
  t161.method("fOffset", [](G4ExtrudedSolid::ZSection& a) -> G4TwoVector& { return a.fOffset; });
  t161.method("fOffset", [](const G4ExtrudedSolid::ZSection* a) -> const G4TwoVector& { return a->fOffset; });
  t161.method("fOffset", [](G4ExtrudedSolid::ZSection* a) -> G4TwoVector& { return a->fOffset; });
  // defined in /Users/mato/.julia/artifacts/9d4b417a98ec8f720b8871baefe87108f864656f/include/Geant4/G4ExtrudedSolid.hh:83:19
  // signature to use in the veto list: G4ExtrudedSolid::ZSection::fOffset
  ...
  t161.method("fOffset!", [](G4ExtrudedSolid::ZSection& a, const G4TwoVector& val) -> G4TwoVector& { return a.fOffset = val; });
  ...
  t161.method("fScale", [](const G4ExtrudedSolid::ZSection& a) -> G4double { return a.fScale; });
  t161.method("fScale", [](G4ExtrudedSolid::ZSection& a) -> G4double { return a.fScale; });
  t161.method("fScale", [](const G4ExtrudedSolid::ZSection* a) -> G4double { return a->fScale; });
  t161.method("fScale", [](G4ExtrudedSolid::ZSection* a) -> G4double { return a->fScale; });
  // defined in /Users/mato/.julia/artifacts/9d4b417a98ec8f720b8871baefe87108f864656f/include/Geant4/G4ExtrudedSolid.hh:84:19
  // signature to use in the veto list: G4ExtrudedSolid::ZSection::fScale
  ...
  t161.method("fScale!", [](G4ExtrudedSolid::ZSection& a, G4double val) -> G4double { return a.fScale = val; });
