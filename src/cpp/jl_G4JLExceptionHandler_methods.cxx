...
void add_methods_for_G4JLExceptionHandler(jlcxx::Module& types, jlcxx::TypeWrapper<G4JLExceptionHandler>& t105) {
  ...
  // defined in ./cpp/Geant4Wrap.h:35:10
  t105.method("Notify", static_cast<G4bool (G4JLExceptionHandler::*)(const char *, const char *, G4ExceptionSeverity, const char *) >(&G4JLExceptionHandler::Notify));
