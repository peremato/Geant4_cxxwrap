...
void add_methods_for_G4Event(jlcxx::Module& types, jlcxx::TypeWrapper<G4Event>& t92) {
  ...
  t92.constructor<G4int>(/*finalize=*/true);
  ...
  t92.method("==", static_cast<G4bool (G4Event::*)(const G4Event &)  const>(&G4Event::operator==));
  ...
  t92.method("Print", static_cast<void (G4Event::*)()  const>(&G4Event::Print));
  ...
  t92.method("Draw", static_cast<void (G4Event::*)()  const>(&G4Event::Draw));
  ...
  t92.method("SetEventID", static_cast<void (G4Event::*)(G4int) >(&G4Event::SetEventID));
  ...
  t92.method("SetHCofThisEvent", static_cast<void (G4Event::*)(G4HCofThisEvent *) >(&G4Event::SetHCofThisEvent));
  ...
  t92.method("SetDCofThisEvent", static_cast<void (G4Event::*)(G4DCofThisEvent *) >(&G4Event::SetDCofThisEvent));
  ...
  t92.method("SetTrajectoryContainer", static_cast<void (G4Event::*)(G4TrajectoryContainer *) >(&G4Event::SetTrajectoryContainer));
  ...
  t92.method("SetEventAborted", static_cast<void (G4Event::*)() >(&G4Event::SetEventAborted));
  ...
  t92.method("SetRandomNumberStatus", static_cast<void (G4Event::*)(G4String &) >(&G4Event::SetRandomNumberStatus));
  ...
  t92.method("SetRandomNumberStatusForProcessing", static_cast<void (G4Event::*)(G4String &) >(&G4Event::SetRandomNumberStatusForProcessing));
  ...
  t92.method("KeepTheEvent", static_cast<void (G4Event::*)(G4bool) >(&G4Event::KeepTheEvent));
  t92.method("KeepTheEvent", [](G4Event& a)->void{ a.KeepTheEvent(); });
  t92.method("KeepTheEvent", [](G4Event* a)->void{ a->KeepTheEvent(); });
  ...
  t92.method("ToBeKept", static_cast<G4bool (G4Event::*)()  const>(&G4Event::ToBeKept));
  ...
  t92.method("KeepForPostProcessing", static_cast<void (G4Event::*)()  const>(&G4Event::KeepForPostProcessing));
  ...
  t92.method("PostProcessingFinished", static_cast<void (G4Event::*)()  const>(&G4Event::PostProcessingFinished));
  ...
  t92.method("GetNumberOfGrips", static_cast<G4int (G4Event::*)()  const>(&G4Event::GetNumberOfGrips));
  ...
  t92.method("GetEventID", static_cast<G4int (G4Event::*)()  const>(&G4Event::GetEventID));
  ...
  t92.method("AddPrimaryVertex", static_cast<void (G4Event::*)(G4PrimaryVertex *) >(&G4Event::AddPrimaryVertex));
  ...
  t92.method("GetNumberOfPrimaryVertex", static_cast<G4int (G4Event::*)()  const>(&G4Event::GetNumberOfPrimaryVertex));
  ...
  t92.method("GetPrimaryVertex", static_cast<G4PrimaryVertex * (G4Event::*)(G4int)  const>(&G4Event::GetPrimaryVertex));
  t92.method("GetPrimaryVertex", [](G4Event const& a)->G4PrimaryVertex *{ return a.GetPrimaryVertex(); });
  t92.method("GetPrimaryVertex", [](G4Event const* a)->G4PrimaryVertex *{ return a->GetPrimaryVertex(); });
  ...
  t92.method("GetHCofThisEvent", static_cast<G4HCofThisEvent * (G4Event::*)()  const>(&G4Event::GetHCofThisEvent));
  ...
  t92.method("GetDCofThisEvent", static_cast<G4DCofThisEvent * (G4Event::*)()  const>(&G4Event::GetDCofThisEvent));
  ...
  t92.method("GetTrajectoryContainer", static_cast<G4TrajectoryContainer * (G4Event::*)()  const>(&G4Event::GetTrajectoryContainer));
  ...
  t92.method("IsAborted", static_cast<G4bool (G4Event::*)()  const>(&G4Event::IsAborted));
  ...
  t92.method("SetUserInformation", static_cast<void (G4Event::*)(G4VUserEventInformation *) >(&G4Event::SetUserInformation));
  ...
  t92.method("GetUserInformation", static_cast<G4VUserEventInformation * (G4Event::*)()  const>(&G4Event::GetUserInformation));
  ...
  t92.method("GetRandomNumberStatus", static_cast<const G4String & (G4Event::*)()  const>(&G4Event::GetRandomNumberStatus));
  ...
  t92.method("GetRandomNumberStatusForProcessing", static_cast<const G4String & (G4Event::*)()  const>(&G4Event::GetRandomNumberStatusForProcessing));
