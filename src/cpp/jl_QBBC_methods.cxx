...
void add_methods_for_QBBC(jlcxx::Module& types, jlcxx::TypeWrapper<QBBC>& t191) {
  ...
  t191.constructor<G4int>(/*finalize=*/true);
  t191.constructor<G4int, const G4String &>(/*finalize=*/true);
