...
void add_methods_for_QBBC(jlcxx::Module& types, jlcxx::TypeWrapper<QBBC>& t220) {
  ...
  t220.constructor<G4int>(/*finalize=*/true);
  t220.constructor<G4int, const G4String &>(/*finalize=*/true);
