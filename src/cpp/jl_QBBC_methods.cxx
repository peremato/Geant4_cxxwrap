...
void add_methods_for_QBBC(jlcxx::Module& types, jlcxx::TypeWrapper<QBBC>& t174) {
  ...
  t174.constructor<G4int>(/*finalize=*/true);
  t174.constructor<G4int, const G4String &>(/*finalize=*/true);
