...
void add_methods_for_QBBC(jlcxx::Module& types, jlcxx::TypeWrapper<QBBC>& t213) {
  ...
  t213.constructor<G4int>(/*finalize=*/true);
  t213.constructor<G4int, const G4String &>(/*finalize=*/true);
