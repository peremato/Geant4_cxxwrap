...
void add_methods_for_G4UserPhysicsListMessenger(jlcxx::Module& types, jlcxx::TypeWrapper<G4UserPhysicsListMessenger>& t221) {
  ...
  t221.constructor<G4VUserPhysicsList *>(/*finalize=*/true);
  ...
  t221.method("SetNewValue", static_cast<void (G4UserPhysicsListMessenger::*)(G4UIcommand *, G4String) >(&G4UserPhysicsListMessenger::SetNewValue));
  ...
  t221.method("GetCurrentValue", static_cast<G4String (G4UserPhysicsListMessenger::*)(G4UIcommand *) >(&G4UserPhysicsListMessenger::GetCurrentValue));
