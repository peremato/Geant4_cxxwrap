...
void add_methods_for_G4UserPhysicsListMessenger(jlcxx::Module& types, jlcxx::TypeWrapper<G4UserPhysicsListMessenger>& t168) {
  ...
  t168.constructor<G4VUserPhysicsList *>(/*finalize=*/true);
  ...
  t168.method("SetNewValue", static_cast<void (G4UserPhysicsListMessenger::*)(G4UIcommand *, G4String) >(&G4UserPhysicsListMessenger::SetNewValue));
  ...
  t168.method("GetCurrentValue", static_cast<G4String (G4UserPhysicsListMessenger::*)(G4UIcommand *) >(&G4UserPhysicsListMessenger::GetCurrentValue));
