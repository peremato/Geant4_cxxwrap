...
void add_methods_for_G4UserPhysicsListMessenger(jlcxx::Module& types, jlcxx::TypeWrapper<G4UserPhysicsListMessenger>& t207) {
  ...
  t207.constructor<G4VUserPhysicsList *>(/*finalize=*/true);
  ...
  t207.method("SetNewValue", static_cast<void (G4UserPhysicsListMessenger::*)(G4UIcommand *, G4String) >(&G4UserPhysicsListMessenger::SetNewValue));
  ...
  t207.method("GetCurrentValue", static_cast<G4String (G4UserPhysicsListMessenger::*)(G4UIcommand *) >(&G4UserPhysicsListMessenger::GetCurrentValue));
