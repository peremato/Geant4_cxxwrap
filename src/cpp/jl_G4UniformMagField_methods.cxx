...
void add_methods_for_G4UniformMagField(jlcxx::Module& types, jlcxx::TypeWrapper<G4UniformMagField>& t239) {
  ...
  t239.constructor<const G4ThreeVector &>(/*finalize=*/true);
  ...
  t239.constructor<G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t239.constructor<const G4UniformMagField &>(/*finalize=*/true);
  ...
  t239.method("assign", static_cast<G4UniformMagField & (G4UniformMagField::*)(const G4UniformMagField &) >(&G4UniformMagField::operator=));
  ...
  t239.method("SetFieldValue", static_cast<void (G4UniformMagField::*)(const G4ThreeVector &) >(&G4UniformMagField::SetFieldValue));
  ...
  t239.method("GetConstantFieldValue", static_cast<G4ThreeVector (G4UniformMagField::*)()  const>(&G4UniformMagField::GetConstantFieldValue));
  ...
  t239.method("Clone", static_cast<G4Field * (G4UniformMagField::*)()  const>(&G4UniformMagField::Clone));
