...
struct JlG4JLWorkerInitialization: public Wrapper {
  ...
  JlG4JLWorkerInitialization(jlcxx::Module& jlModule): Wrapper(jlModule){
    ...
    // defined in cpp/Geant4Wrap.h:135:7
  ...
  void add_methods() const{
    ...
    // defined in cpp/Geant4Wrap.h:139:18
    t.method("WorkerInitialize", [](G4JLWorkerInitialization const& a)->void { a.WorkerInitialize(); }, jlcxx::arg("this"));
    t.method("WorkerInitialize", [](G4JLWorkerInitialization const* a)->void { a->WorkerInitialize(); }, jlcxx::arg("this"));
    ...
    // defined in cpp/Geant4Wrap.h:140:18
    t.method("WorkerStart", [](G4JLWorkerInitialization const& a)->void { a.WorkerStart(); }, jlcxx::arg("this"));
    t.method("WorkerStart", [](G4JLWorkerInitialization const* a)->void { a->WorkerStart(); }, jlcxx::arg("this"));
    ...
    // defined in cpp/Geant4Wrap.h:141:18
    t.method("WorkerRunStart", [](G4JLWorkerInitialization const& a)->void { a.WorkerRunStart(); }, jlcxx::arg("this"));
    t.method("WorkerRunStart", [](G4JLWorkerInitialization const* a)->void { a->WorkerRunStart(); }, jlcxx::arg("this"));
    ...
    // defined in cpp/Geant4Wrap.h:142:18
    t.method("WorkerRunEnd", [](G4JLWorkerInitialization const& a)->void { a.WorkerRunEnd(); }, jlcxx::arg("this"));
    t.method("WorkerRunEnd", [](G4JLWorkerInitialization const* a)->void { a->WorkerRunEnd(); }, jlcxx::arg("this"));
    ...
    // defined in cpp/Geant4Wrap.h:143:18
    t.method("WorkerStop", [](G4JLWorkerInitialization const& a)->void { a.WorkerStop(); }, jlcxx::arg("this"));
    t.method("WorkerStop", [](G4JLWorkerInitialization const* a)->void { a->WorkerStop(); }, jlcxx::arg("this"));
  }
