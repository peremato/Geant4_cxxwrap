...
void add_methods_for_G4Hype(jlcxx::Module& types, jlcxx::TypeWrapper<G4Hype>& t187) {
  ...
  t187.constructor<const G4String &, G4double, G4double, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t187.method("ComputeDimensions", static_cast<void (G4Hype::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4Hype::ComputeDimensions));
  ...
  t187.method("BoundingLimits", static_cast<void (G4Hype::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Hype::BoundingLimits));
  ...
  t187.method("GetInnerRadius", static_cast<G4double (G4Hype::*)()  const>(&G4Hype::GetInnerRadius));
  ...
  t187.method("GetOuterRadius", static_cast<G4double (G4Hype::*)()  const>(&G4Hype::GetOuterRadius));
  ...
  t187.method("GetZHalfLength", static_cast<G4double (G4Hype::*)()  const>(&G4Hype::GetZHalfLength));
  ...
  t187.method("GetInnerStereo", static_cast<G4double (G4Hype::*)()  const>(&G4Hype::GetInnerStereo));
  ...
  t187.method("GetOuterStereo", static_cast<G4double (G4Hype::*)()  const>(&G4Hype::GetOuterStereo));
  ...
  t187.method("SetInnerRadius", static_cast<void (G4Hype::*)(G4double) >(&G4Hype::SetInnerRadius));
  ...
  t187.method("SetOuterRadius", static_cast<void (G4Hype::*)(G4double) >(&G4Hype::SetOuterRadius));
  ...
  t187.method("SetZHalfLength", static_cast<void (G4Hype::*)(G4double) >(&G4Hype::SetZHalfLength));
  ...
  t187.method("SetInnerStereo", static_cast<void (G4Hype::*)(G4double) >(&G4Hype::SetInnerStereo));
  ...
  t187.method("SetOuterStereo", static_cast<void (G4Hype::*)(G4double) >(&G4Hype::SetOuterStereo));
  ...
  t187.method("Inside", static_cast<EInside (G4Hype::*)(const G4ThreeVector &)  const>(&G4Hype::Inside));
  ...
  t187.method("SurfaceNormal", static_cast<G4ThreeVector (G4Hype::*)(const G4ThreeVector &)  const>(&G4Hype::SurfaceNormal));
  ...
  t187.method("DistanceToIn", static_cast<G4double (G4Hype::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Hype::DistanceToIn));
  ...
  t187.method("DistanceToIn", static_cast<G4double (G4Hype::*)(const G4ThreeVector &)  const>(&G4Hype::DistanceToIn));
  ...
  t187.method("DistanceToOut", static_cast<G4double (G4Hype::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Hype::DistanceToOut));
  t187.method("DistanceToOut", [](G4Hype const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t187.method("DistanceToOut", [](G4Hype const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t187.method("DistanceToOut", [](G4Hype const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t187.method("DistanceToOut", [](G4Hype const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t187.method("DistanceToOut", [](G4Hype const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t187.method("DistanceToOut", [](G4Hype const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t187.method("DistanceToOut", static_cast<G4double (G4Hype::*)(const G4ThreeVector &)  const>(&G4Hype::DistanceToOut));
  ...
  t187.method("GetEntityType", static_cast<G4GeometryType (G4Hype::*)()  const>(&G4Hype::GetEntityType));
  ...
  t187.method("Clone", static_cast<G4VSolid * (G4Hype::*)()  const>(&G4Hype::Clone));
  ...
  t187.method("GetCubicVolume", static_cast<G4double (G4Hype::*)() >(&G4Hype::GetCubicVolume));
  ...
  t187.method("GetSurfaceArea", static_cast<G4double (G4Hype::*)() >(&G4Hype::GetSurfaceArea));
  ...
  t187.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Hype::*)()  const>(&G4Hype::GetPointOnSurface));
  ...
  t187.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Hype::*)()  const>(&G4Hype::CreatePolyhedron));
  ...
  t187.method("GetPolyhedron", static_cast<G4Polyhedron * (G4Hype::*)()  const>(&G4Hype::GetPolyhedron));
  ...
  t187.constructor<const G4Hype &>(/*finalize=*/true);
  ...
  t187.method("assign", static_cast<G4Hype & (G4Hype::*)(const G4Hype &) >(&G4Hype::operator=));
