...
void add_methods_for_G4Hype(jlcxx::Module& types, jlcxx::TypeWrapper<G4Hype>& t203) {
  ...
  t203.method("ComputeDimensions", static_cast<void (G4Hype::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4Hype::ComputeDimensions));
  ...
  t203.method("BoundingLimits", static_cast<void (G4Hype::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Hype::BoundingLimits));
  ...
  t203.method("GetInnerRadius", static_cast<G4double (G4Hype::*)()  const>(&G4Hype::GetInnerRadius));
  ...
  t203.method("GetOuterRadius", static_cast<G4double (G4Hype::*)()  const>(&G4Hype::GetOuterRadius));
  ...
  t203.method("GetZHalfLength", static_cast<G4double (G4Hype::*)()  const>(&G4Hype::GetZHalfLength));
  ...
  t203.method("GetInnerStereo", static_cast<G4double (G4Hype::*)()  const>(&G4Hype::GetInnerStereo));
  ...
  t203.method("GetOuterStereo", static_cast<G4double (G4Hype::*)()  const>(&G4Hype::GetOuterStereo));
  ...
  t203.method("SetInnerRadius", static_cast<void (G4Hype::*)(G4double) >(&G4Hype::SetInnerRadius));
  ...
  t203.method("SetOuterRadius", static_cast<void (G4Hype::*)(G4double) >(&G4Hype::SetOuterRadius));
  ...
  t203.method("SetZHalfLength", static_cast<void (G4Hype::*)(G4double) >(&G4Hype::SetZHalfLength));
  ...
  t203.method("SetInnerStereo", static_cast<void (G4Hype::*)(G4double) >(&G4Hype::SetInnerStereo));
  ...
  t203.method("SetOuterStereo", static_cast<void (G4Hype::*)(G4double) >(&G4Hype::SetOuterStereo));
  ...
  t203.method("Inside", static_cast<EInside (G4Hype::*)(const G4ThreeVector &)  const>(&G4Hype::Inside));
  ...
  t203.method("SurfaceNormal", static_cast<G4ThreeVector (G4Hype::*)(const G4ThreeVector &)  const>(&G4Hype::SurfaceNormal));
  ...
  t203.method("DistanceToIn", static_cast<G4double (G4Hype::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Hype::DistanceToIn));
  ...
  t203.method("DistanceToIn", static_cast<G4double (G4Hype::*)(const G4ThreeVector &)  const>(&G4Hype::DistanceToIn));
  ...
  t203.method("DistanceToOut", static_cast<G4double (G4Hype::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Hype::DistanceToOut));
  t203.method("DistanceToOut", [](G4Hype const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t203.method("DistanceToOut", [](G4Hype const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t203.method("DistanceToOut", [](G4Hype const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t203.method("DistanceToOut", [](G4Hype const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t203.method("DistanceToOut", [](G4Hype const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t203.method("DistanceToOut", [](G4Hype const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t203.method("DistanceToOut", static_cast<G4double (G4Hype::*)(const G4ThreeVector &)  const>(&G4Hype::DistanceToOut));
  ...
  t203.method("GetEntityType", static_cast<G4GeometryType (G4Hype::*)()  const>(&G4Hype::GetEntityType));
  ...
  t203.method("Clone", static_cast<G4VSolid * (G4Hype::*)()  const>(&G4Hype::Clone));
  ...
  t203.method("GetCubicVolume", static_cast<G4double (G4Hype::*)() >(&G4Hype::GetCubicVolume));
  ...
  t203.method("GetSurfaceArea", static_cast<G4double (G4Hype::*)() >(&G4Hype::GetSurfaceArea));
  ...
  t203.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Hype::*)()  const>(&G4Hype::GetPointOnSurface));
  ...
  t203.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Hype::*)()  const>(&G4Hype::CreatePolyhedron));
  ...
  t203.method("GetPolyhedron", static_cast<G4Polyhedron * (G4Hype::*)()  const>(&G4Hype::GetPolyhedron));
  ...
  t203.constructor<const G4Hype &>(/*finalize=*/true);
  ...
  t203.method("assign", static_cast<G4Hype & (G4Hype::*)(const G4Hype &) >(&G4Hype::operator=));
