...
void add_methods_for_G4VUserActionInitialization(jlcxx::Module& types, jlcxx::TypeWrapper<G4VUserActionInitialization>& t91) {
  ...
  t91.method("Build", static_cast<void (G4VUserActionInitialization::*)()  const>(&G4VUserActionInitialization::Build));
  ...
  t91.method("BuildForMaster", static_cast<void (G4VUserActionInitialization::*)()  const>(&G4VUserActionInitialization::BuildForMaster));
  ...
  t91.method("InitializeSteppingVerbose", static_cast<G4VSteppingVerbose * (G4VUserActionInitialization::*)()  const>(&G4VUserActionInitialization::InitializeSteppingVerbose));
