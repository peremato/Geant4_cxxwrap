...
void add_methods_for_G4VUserActionInitialization(jlcxx::Module& types, jlcxx::TypeWrapper<G4VUserActionInitialization>& t90) {
  ...
  t90.method("Build", static_cast<void (G4VUserActionInitialization::*)()  const>(&G4VUserActionInitialization::Build));
  ...
  t90.method("BuildForMaster", static_cast<void (G4VUserActionInitialization::*)()  const>(&G4VUserActionInitialization::BuildForMaster));
  ...
  t90.method("InitializeSteppingVerbose", static_cast<G4VSteppingVerbose * (G4VUserActionInitialization::*)()  const>(&G4VUserActionInitialization::InitializeSteppingVerbose));
