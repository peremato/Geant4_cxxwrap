...
void add_methods_for_G4OpBoundaryProcess(jlcxx::Module& types, jlcxx::TypeWrapper<G4OpBoundaryProcess>& t225) {
  ...
  t225.constructor<const G4String &>(/*finalize=*/true);
  t225.constructor<const G4String &, G4ProcessType>(/*finalize=*/true);
  ...
  t225.method("IsApplicable", static_cast<G4bool (G4OpBoundaryProcess::*)(const G4ParticleDefinition &) >(&G4OpBoundaryProcess::IsApplicable));
  ...
  t225.method("GetMeanFreePath", static_cast<G4double (G4OpBoundaryProcess::*)(const G4Track &, G4double, G4ForceCondition *) >(&G4OpBoundaryProcess::GetMeanFreePath));
  ...
  t225.method("PostStepDoIt", static_cast<G4VParticleChange * (G4OpBoundaryProcess::*)(const G4Track &, const G4Step &) >(&G4OpBoundaryProcess::PostStepDoIt));
  ...
  t225.method("GetStatus", static_cast<G4OpBoundaryProcessStatus (G4OpBoundaryProcess::*)()  const>(&G4OpBoundaryProcess::GetStatus));
  ...
  t225.method("SetInvokeSD", static_cast<void (G4OpBoundaryProcess::*)(G4bool) >(&G4OpBoundaryProcess::SetInvokeSD));
  ...
  t225.method("PreparePhysicsTable", static_cast<void (G4OpBoundaryProcess::*)(const G4ParticleDefinition &) >(&G4OpBoundaryProcess::PreparePhysicsTable));
  ...
  t225.method("Initialise", static_cast<void (G4OpBoundaryProcess::*)() >(&G4OpBoundaryProcess::Initialise));
  ...
  t225.method("SetVerboseLevel", static_cast<void (G4OpBoundaryProcess::*)(G4int) >(&G4OpBoundaryProcess::SetVerboseLevel));
