...
void add_methods_for_G4Ellipsoid(jlcxx::Module& types, jlcxx::TypeWrapper<G4Ellipsoid>& t171) {
  ...
  t171.constructor<const G4String &, G4double, G4double, G4double>(/*finalize=*/true);
  t171.constructor<const G4String &, G4double, G4double, G4double, G4double>(/*finalize=*/true);
  t171.constructor<const G4String &, G4double, G4double, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t171.method("GetDx", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetDx));
  ...
  t171.method("GetDy", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetDy));
  ...
  t171.method("GetDz", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetDz));
  ...
  t171.method("GetSemiAxisMax", static_cast<G4double (G4Ellipsoid::*)(G4int)  const>(&G4Ellipsoid::GetSemiAxisMax));
  ...
  t171.method("GetZBottomCut", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetZBottomCut));
  ...
  t171.method("GetZTopCut", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetZTopCut));
  ...
  t171.method("SetSemiAxis", static_cast<void (G4Ellipsoid::*)(G4double, G4double, G4double) >(&G4Ellipsoid::SetSemiAxis));
  ...
  t171.method("SetZCuts", static_cast<void (G4Ellipsoid::*)(G4double, G4double) >(&G4Ellipsoid::SetZCuts));
  ...
  t171.method("ComputeDimensions", static_cast<void (G4Ellipsoid::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4Ellipsoid::ComputeDimensions));
  ...
  t171.method("BoundingLimits", static_cast<void (G4Ellipsoid::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Ellipsoid::BoundingLimits));
  ...
  t171.method("Inside", static_cast<EInside (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::Inside));
  ...
  t171.method("SurfaceNormal", static_cast<G4ThreeVector (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::SurfaceNormal));
  ...
  t171.method("DistanceToIn", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Ellipsoid::DistanceToIn));
  ...
  t171.method("DistanceToIn", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::DistanceToIn));
  ...
  t171.method("DistanceToOut", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Ellipsoid::DistanceToOut));
  t171.method("DistanceToOut", [](G4Ellipsoid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t171.method("DistanceToOut", [](G4Ellipsoid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t171.method("DistanceToOut", [](G4Ellipsoid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t171.method("DistanceToOut", [](G4Ellipsoid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t171.method("DistanceToOut", [](G4Ellipsoid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t171.method("DistanceToOut", [](G4Ellipsoid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t171.method("DistanceToOut", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::DistanceToOut));
  ...
  t171.method("GetEntityType", static_cast<G4GeometryType (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetEntityType));
  ...
  t171.method("Clone", static_cast<G4VSolid * (G4Ellipsoid::*)()  const>(&G4Ellipsoid::Clone));
  ...
  t171.method("GetCubicVolume", static_cast<G4double (G4Ellipsoid::*)() >(&G4Ellipsoid::GetCubicVolume));
  ...
  t171.method("GetSurfaceArea", static_cast<G4double (G4Ellipsoid::*)() >(&G4Ellipsoid::GetSurfaceArea));
  ...
  t171.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetPointOnSurface));
  ...
  t171.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Ellipsoid::*)()  const>(&G4Ellipsoid::CreatePolyhedron));
  ...
  t171.method("GetPolyhedron", static_cast<G4Polyhedron * (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetPolyhedron));
  ...
  t171.constructor<const G4Ellipsoid &>(/*finalize=*/true);
  ...
  t171.method("assign", static_cast<G4Ellipsoid & (G4Ellipsoid::*)(const G4Ellipsoid &) >(&G4Ellipsoid::operator=));
