...
void add_methods_for_G4Ellipsoid(jlcxx::Module& types, jlcxx::TypeWrapper<G4Ellipsoid>& t197) {
  ...
  t197.constructor<const G4String &, G4double, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t197.method("GetDx", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetDx));
  ...
  t197.method("GetDy", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetDy));
  ...
  t197.method("GetDz", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetDz));
  ...
  t197.method("GetSemiAxisMax", static_cast<G4double (G4Ellipsoid::*)(G4int)  const>(&G4Ellipsoid::GetSemiAxisMax));
  ...
  t197.method("GetZBottomCut", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetZBottomCut));
  ...
  t197.method("GetZTopCut", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetZTopCut));
  ...
  t197.method("SetSemiAxis", static_cast<void (G4Ellipsoid::*)(G4double, G4double, G4double) >(&G4Ellipsoid::SetSemiAxis));
  ...
  t197.method("SetZCuts", static_cast<void (G4Ellipsoid::*)(G4double, G4double) >(&G4Ellipsoid::SetZCuts));
  ...
  t197.method("ComputeDimensions", static_cast<void (G4Ellipsoid::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4Ellipsoid::ComputeDimensions));
  ...
  t197.method("BoundingLimits", static_cast<void (G4Ellipsoid::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Ellipsoid::BoundingLimits));
  ...
  t197.method("Inside", static_cast<EInside (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::Inside));
  ...
  t197.method("SurfaceNormal", static_cast<G4ThreeVector (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::SurfaceNormal));
  ...
  t197.method("DistanceToIn", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Ellipsoid::DistanceToIn));
  ...
  t197.method("DistanceToIn", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::DistanceToIn));
  ...
  t197.method("DistanceToOut", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Ellipsoid::DistanceToOut));
  t197.method("DistanceToOut", [](G4Ellipsoid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t197.method("DistanceToOut", [](G4Ellipsoid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t197.method("DistanceToOut", [](G4Ellipsoid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t197.method("DistanceToOut", [](G4Ellipsoid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t197.method("DistanceToOut", [](G4Ellipsoid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t197.method("DistanceToOut", [](G4Ellipsoid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t197.method("DistanceToOut", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::DistanceToOut));
  ...
  t197.method("GetEntityType", static_cast<G4GeometryType (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetEntityType));
  ...
  t197.method("Clone", static_cast<G4VSolid * (G4Ellipsoid::*)()  const>(&G4Ellipsoid::Clone));
  ...
  t197.method("GetCubicVolume", static_cast<G4double (G4Ellipsoid::*)() >(&G4Ellipsoid::GetCubicVolume));
  ...
  t197.method("GetSurfaceArea", static_cast<G4double (G4Ellipsoid::*)() >(&G4Ellipsoid::GetSurfaceArea));
  ...
  t197.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetPointOnSurface));
  ...
  t197.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Ellipsoid::*)()  const>(&G4Ellipsoid::CreatePolyhedron));
  ...
  t197.method("GetPolyhedron", static_cast<G4Polyhedron * (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetPolyhedron));
  ...
  t197.constructor<const G4Ellipsoid &>(/*finalize=*/true);
  ...
  t197.method("assign", static_cast<G4Ellipsoid & (G4Ellipsoid::*)(const G4Ellipsoid &) >(&G4Ellipsoid::operator=));
