...
void add_methods_for_G4Ellipsoid(jlcxx::Module& types, jlcxx::TypeWrapper<G4Ellipsoid>& t188) {
  ...
  t188.constructor<const G4String &, G4double, G4double, G4double>(/*finalize=*/true);
  t188.constructor<const G4String &, G4double, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t188.method("GetDx", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetDx));
  ...
  t188.method("GetDy", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetDy));
  ...
  t188.method("GetDz", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetDz));
  ...
  t188.method("GetSemiAxisMax", static_cast<G4double (G4Ellipsoid::*)(G4int)  const>(&G4Ellipsoid::GetSemiAxisMax));
  ...
  t188.method("GetZBottomCut", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetZBottomCut));
  ...
  t188.method("GetZTopCut", static_cast<G4double (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetZTopCut));
  ...
  t188.method("SetSemiAxis", static_cast<void (G4Ellipsoid::*)(G4double, G4double, G4double) >(&G4Ellipsoid::SetSemiAxis));
  ...
  t188.method("SetZCuts", static_cast<void (G4Ellipsoid::*)(G4double, G4double) >(&G4Ellipsoid::SetZCuts));
  ...
  t188.method("ComputeDimensions", static_cast<void (G4Ellipsoid::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4Ellipsoid::ComputeDimensions));
  ...
  t188.method("BoundingLimits", static_cast<void (G4Ellipsoid::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Ellipsoid::BoundingLimits));
  ...
  t188.method("Inside", static_cast<EInside (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::Inside));
  ...
  t188.method("SurfaceNormal", static_cast<G4ThreeVector (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::SurfaceNormal));
  ...
  t188.method("DistanceToIn", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Ellipsoid::DistanceToIn));
  ...
  t188.method("DistanceToIn", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::DistanceToIn));
  ...
  t188.method("DistanceToOut", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Ellipsoid::DistanceToOut));
  t188.method("DistanceToOut", [](G4Ellipsoid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t188.method("DistanceToOut", [](G4Ellipsoid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t188.method("DistanceToOut", [](G4Ellipsoid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t188.method("DistanceToOut", [](G4Ellipsoid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t188.method("DistanceToOut", [](G4Ellipsoid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t188.method("DistanceToOut", [](G4Ellipsoid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t188.method("DistanceToOut", static_cast<G4double (G4Ellipsoid::*)(const G4ThreeVector &)  const>(&G4Ellipsoid::DistanceToOut));
  ...
  t188.method("GetEntityType", static_cast<G4GeometryType (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetEntityType));
  ...
  t188.method("Clone", static_cast<G4VSolid * (G4Ellipsoid::*)()  const>(&G4Ellipsoid::Clone));
  ...
  t188.method("GetCubicVolume", static_cast<G4double (G4Ellipsoid::*)() >(&G4Ellipsoid::GetCubicVolume));
  ...
  t188.method("GetSurfaceArea", static_cast<G4double (G4Ellipsoid::*)() >(&G4Ellipsoid::GetSurfaceArea));
  ...
  t188.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetPointOnSurface));
  ...
  t188.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Ellipsoid::*)()  const>(&G4Ellipsoid::CreatePolyhedron));
  ...
  t188.method("GetPolyhedron", static_cast<G4Polyhedron * (G4Ellipsoid::*)()  const>(&G4Ellipsoid::GetPolyhedron));
  ...
  t188.constructor<const G4Ellipsoid &>(/*finalize=*/true);
  ...
  t188.method("assign", static_cast<G4Ellipsoid & (G4Ellipsoid::*)(const G4Ellipsoid &) >(&G4Ellipsoid::operator=));
