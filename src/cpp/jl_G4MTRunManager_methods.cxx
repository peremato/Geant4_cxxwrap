...
void add_methods_for_G4MTRunManager(jlcxx::Module& types, jlcxx::TypeWrapper<G4MTRunManager>& t151) {
  ...
  t151.method("SetNumberOfThreads", static_cast<void (G4MTRunManager::*)(G4int) >(&G4MTRunManager::SetNumberOfThreads));
  ...
  t151.method("GetNumberOfThreads", static_cast<G4int (G4MTRunManager::*)()  const>(&G4MTRunManager::GetNumberOfThreads));
  ...
  t151.method("SetPinAffinity", static_cast<void (G4MTRunManager::*)(G4int) >(&G4MTRunManager::SetPinAffinity));
  t151.method("SetPinAffinity", [](G4MTRunManager& a)->void{ a.SetPinAffinity(); });
  t151.method("SetPinAffinity", [](G4MTRunManager* a)->void{ a->SetPinAffinity(); });
  ...
  t151.method("GetPinAffinity", static_cast<G4int (G4MTRunManager::*)()  const>(&G4MTRunManager::GetPinAffinity));
  ...
  t151.method("Initialize", static_cast<void (G4MTRunManager::*)() >(&G4MTRunManager::Initialize));
  ...
  t151.method("InitializeEventLoop", static_cast<void (G4MTRunManager::*)(G4int, const char *, G4int) >(&G4MTRunManager::InitializeEventLoop));
  t151.method("InitializeEventLoop", [](G4MTRunManager& a, G4int arg0)->void{ a.InitializeEventLoop(arg0); });
  t151.method("InitializeEventLoop", [](G4MTRunManager& a, G4int arg0, const char * arg1)->void{ a.InitializeEventLoop(arg0, arg1); });
  t151.method("InitializeEventLoop", [](G4MTRunManager* a, G4int arg0)->void{ a->InitializeEventLoop(arg0); });
  t151.method("InitializeEventLoop", [](G4MTRunManager* a, G4int arg0, const char * arg1)->void{ a->InitializeEventLoop(arg0, arg1); });
  ...
  t151.method("InitializeThreadPool", static_cast<void (G4MTRunManager::*)() >(&G4MTRunManager::InitializeThreadPool));
  ...
  t151.method("TerminateOneEvent", static_cast<void (G4MTRunManager::*)() >(&G4MTRunManager::TerminateOneEvent));
  ...
  t151.method("ProcessOneEvent", static_cast<void (G4MTRunManager::*)(G4int) >(&G4MTRunManager::ProcessOneEvent));
  ...
  t151.method("ConstructScoringWorlds", static_cast<void (G4MTRunManager::*)() >(&G4MTRunManager::ConstructScoringWorlds));
  ...
  t151.method("RunTermination", static_cast<void (G4MTRunManager::*)() >(&G4MTRunManager::RunTermination));
  ...
  t151.method("SetUpAnEvent", static_cast<G4bool (G4MTRunManager::*)(G4Event *, long &, long &, long &, G4bool) >(&G4MTRunManager::SetUpAnEvent));
  t151.method("SetUpAnEvent", [](G4MTRunManager& a, G4Event * arg0, long & arg1, long & arg2, long & arg3)->G4bool{ return a.SetUpAnEvent(arg0, arg1, arg2, arg3); });
  t151.method("SetUpAnEvent", [](G4MTRunManager* a, G4Event * arg0, long & arg1, long & arg2, long & arg3)->G4bool{ return a->SetUpAnEvent(arg0, arg1, arg2, arg3); });
  ...
  t151.method("GetCommandStack", static_cast<std::vector<G4String> (G4MTRunManager::*)() >(&G4MTRunManager::GetCommandStack));
  ...
  t151.method("GetNumberActiveThreads", static_cast<size_t (G4MTRunManager::*)()  const>(&G4MTRunManager::GetNumberActiveThreads));
  ...
  t151.method("ThisWorkerReady", static_cast<void (G4MTRunManager::*)() >(&G4MTRunManager::ThisWorkerReady));
  ...
  t151.method("ThisWorkerEndEventLoop", static_cast<void (G4MTRunManager::*)() >(&G4MTRunManager::ThisWorkerEndEventLoop));
  ...
  t151.method("G4MTRunManager!GetMasterScoringManager", static_cast<G4ScoringManager * (*)() >(&G4MTRunManager::GetMasterScoringManager));
  ...
  t151.method("G4MTRunManager!addWorld", static_cast<void (*)(G4int, G4VPhysicalVolume *) >(&G4MTRunManager::addWorld));
  ...
  t151.method("getMasterRandomEngine", static_cast<const CLHEP::HepRandomEngine * (G4MTRunManager::*)()  const>(&G4MTRunManager::getMasterRandomEngine));
  ...
  t151.method("G4MTRunManager!GetMasterRunManager", static_cast<G4MTRunManager * (*)() >(&G4MTRunManager::GetMasterRunManager));
  ...
  t151.method("G4MTRunManager!GetMasterRunManagerKernel", static_cast<G4RunManagerKernel * (*)() >(&G4MTRunManager::GetMasterRunManagerKernel));
  ...
  t151.method("G4MTRunManager!GetMTMasterRunManagerKernel", static_cast<G4MTRunManagerKernel * (*)() >(&G4MTRunManager::GetMTMasterRunManagerKernel));
  ...
  t151.method("SetUserInitialization", static_cast<void (G4MTRunManager::*)(G4VUserPhysicsList *) >(&G4MTRunManager::SetUserInitialization));
  ...
  t151.method("SetUserInitialization", static_cast<void (G4MTRunManager::*)(G4VUserDetectorConstruction *) >(&G4MTRunManager::SetUserInitialization));
  ...
  t151.method("SetUserInitialization", static_cast<void (G4MTRunManager::*)(G4UserWorkerInitialization *) >(&G4MTRunManager::SetUserInitialization));
  ...
  t151.method("SetUserInitialization", static_cast<void (G4MTRunManager::*)(G4VUserActionInitialization *) >(&G4MTRunManager::SetUserInitialization));
  ...
  t151.method("SetUserAction", static_cast<void (G4MTRunManager::*)(G4UserRunAction *) >(&G4MTRunManager::SetUserAction));
  ...
  t151.method("SetUserAction", static_cast<void (G4MTRunManager::*)(G4VUserPrimaryGeneratorAction *) >(&G4MTRunManager::SetUserAction));
  ...
  t151.method("SetUserAction", static_cast<void (G4MTRunManager::*)(G4UserEventAction *) >(&G4MTRunManager::SetUserAction));
  ...
  t151.method("SetUserAction", static_cast<void (G4MTRunManager::*)(G4UserStackingAction *) >(&G4MTRunManager::SetUserAction));
  ...
  t151.method("SetUserAction", static_cast<void (G4MTRunManager::*)(G4UserTrackingAction *) >(&G4MTRunManager::SetUserAction));
  ...
  t151.method("SetUserAction", static_cast<void (G4MTRunManager::*)(G4UserSteppingAction *) >(&G4MTRunManager::SetUserAction));
  ...
  t151.method("MergeScores", static_cast<void (G4MTRunManager::*)(const G4ScoringManager *) >(&G4MTRunManager::MergeScores));
  ...
  t151.method("MergeRun", static_cast<void (G4MTRunManager::*)(const G4Run *) >(&G4MTRunManager::MergeRun));
  ...
  t151.method("RequestWorkersProcessCommandsStack", static_cast<void (G4MTRunManager::*)() >(&G4MTRunManager::RequestWorkersProcessCommandsStack));
  ...
  t151.method("ThisWorkerProcessCommandsStackDone", static_cast<void (G4MTRunManager::*)() >(&G4MTRunManager::ThisWorkerProcessCommandsStackDone));
  ...
  t151.method("ThisWorkerWaitForNextAction", static_cast<G4MTRunManager::WorkerActionRequest (G4MTRunManager::*)() >(&G4MTRunManager::ThisWorkerWaitForNextAction));
  ...
  t151.method("SetEventModulo", static_cast<void (G4MTRunManager::*)(G4int) >(&G4MTRunManager::SetEventModulo));
  t151.method("SetEventModulo", [](G4MTRunManager& a)->void{ a.SetEventModulo(); });
  t151.method("SetEventModulo", [](G4MTRunManager* a)->void{ a->SetEventModulo(); });
  ...
  t151.method("GetEventModulo", static_cast<G4int (G4MTRunManager::*)()  const>(&G4MTRunManager::GetEventModulo));
  ...
  t151.method("AbortRun", static_cast<void (G4MTRunManager::*)(G4bool) >(&G4MTRunManager::AbortRun));
  t151.method("AbortRun", [](G4MTRunManager& a)->void{ a.AbortRun(); });
  t151.method("AbortRun", [](G4MTRunManager* a)->void{ a->AbortRun(); });
  ...
  t151.method("AbortEvent", static_cast<void (G4MTRunManager::*)() >(&G4MTRunManager::AbortEvent));
  ...
  t151.method("G4MTRunManager!SeedOncePerCommunication", static_cast<G4int (*)() >(&G4MTRunManager::SeedOncePerCommunication));
  ...
  t151.method("G4MTRunManager!SetSeedOncePerCommunication", static_cast<void (*)(G4int) >(&G4MTRunManager::SetSeedOncePerCommunication));
