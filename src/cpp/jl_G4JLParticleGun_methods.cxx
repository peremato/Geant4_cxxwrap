...
void add_methods_for_G4JLParticleGun(jlcxx::Module& types, jlcxx::TypeWrapper<G4JLParticleGun>& t112) {
  ...
  // defined in ./cpp/Geant4Wrap.h:118:18
  t112.method("GetGun", static_cast<G4ParticleGun * (G4JLParticleGun::*)()  const>(&G4JLParticleGun::GetGun));
  ...
  // defined in ./cpp/Geant4Wrap.h:119:8
  t112.method("GeneratePrimaries", static_cast<void (G4JLParticleGun::*)(G4Event *) >(&G4JLParticleGun::GeneratePrimaries));
