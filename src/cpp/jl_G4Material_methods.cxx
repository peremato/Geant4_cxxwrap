...
void add_methods_for_G4Material(jlcxx::Module& types, jlcxx::TypeWrapper<G4Material>& t43) {
  ...
  t43.constructor<const G4String &, G4double, G4double, G4double>(/*finalize=*/false);
  t43.constructor<const G4String &, G4double, G4double, G4double, G4State>(/*finalize=*/false);
  t43.constructor<const G4String &, G4double, G4double, G4double, G4State, G4double>(/*finalize=*/false);
  t43.constructor<const G4String &, G4double, G4double, G4double, G4State, G4double, G4double>(/*finalize=*/false);
  ...
  t43.constructor<const G4String &, G4double, G4int>(/*finalize=*/false);
  t43.constructor<const G4String &, G4double, G4int, G4State>(/*finalize=*/false);
  t43.constructor<const G4String &, G4double, G4int, G4State, G4double>(/*finalize=*/false);
  t43.constructor<const G4String &, G4double, G4int, G4State, G4double, G4double>(/*finalize=*/false);
  ...
  t43.constructor<const G4String &, G4double, const G4Material *>(/*finalize=*/false);
  t43.constructor<const G4String &, G4double, const G4Material *, G4State>(/*finalize=*/false);
  t43.constructor<const G4String &, G4double, const G4Material *, G4State, G4double>(/*finalize=*/false);
  t43.constructor<const G4String &, G4double, const G4Material *, G4State, G4double, G4double>(/*finalize=*/false);
  ...
  t43.method("AddElementByNumberOfAtoms", static_cast<void (G4Material::*)(const G4Element *, G4int) >(&G4Material::AddElementByNumberOfAtoms));
  ...
  t43.method("AddElement", static_cast<void (G4Material::*)(G4Element *, G4int) >(&G4Material::AddElement));
  ...
  t43.method("AddElementByMassFraction", static_cast<void (G4Material::*)(const G4Element *, G4double) >(&G4Material::AddElementByMassFraction));
  ...
  t43.method("AddElement", static_cast<void (G4Material::*)(G4Element *, G4double) >(&G4Material::AddElement));
  ...
  t43.method("AddMaterial", static_cast<void (G4Material::*)(G4Material *, G4double) >(&G4Material::AddMaterial));
  ...
  t43.method("GetName", static_cast<const G4String & (G4Material::*)()  const>(&G4Material::GetName));
  ...
  t43.method("GetChemicalFormula", static_cast<const G4String & (G4Material::*)()  const>(&G4Material::GetChemicalFormula));
  ...
  t43.method("GetFreeElectronDensity", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetFreeElectronDensity));
  ...
  t43.method("GetDensity", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetDensity));
  ...
  t43.method("GetState", static_cast<G4State (G4Material::*)()  const>(&G4Material::GetState));
  ...
  t43.method("GetTemperature", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetTemperature));
  ...
  t43.method("GetPressure", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetPressure));
  ...
  t43.method("GetNumberOfElements", static_cast<size_t (G4Material::*)()  const>(&G4Material::GetNumberOfElements));
  ...
  t43.method("GetElementVector", static_cast<const G4ElementVector * (G4Material::*)()  const>(&G4Material::GetElementVector));
  ...
  t43.method("GetFractionVector", static_cast<const G4double * (G4Material::*)()  const>(&G4Material::GetFractionVector));
  ...
  t43.method("GetAtomsVector", static_cast<const G4int * (G4Material::*)()  const>(&G4Material::GetAtomsVector));
  ...
  t43.method("GetElement", static_cast<const G4Element * (G4Material::*)(G4int)  const>(&G4Material::GetElement));
  ...
  t43.method("GetVecNbOfAtomsPerVolume", static_cast<const G4double * (G4Material::*)()  const>(&G4Material::GetVecNbOfAtomsPerVolume));
  ...
  t43.method("GetTotNbOfAtomsPerVolume", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetTotNbOfAtomsPerVolume));
  ...
  t43.method("GetTotNbOfElectPerVolume", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetTotNbOfElectPerVolume));
  ...
  t43.method("GetAtomicNumDensityVector", static_cast<const G4double * (G4Material::*)()  const>(&G4Material::GetAtomicNumDensityVector));
  ...
  t43.method("GetElectronDensity", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetElectronDensity));
  ...
  t43.method("GetRadlen", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetRadlen));
  ...
  t43.method("GetNuclearInterLength", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetNuclearInterLength));
  ...
  t43.method("GetIonisation", static_cast<G4IonisParamMat * (G4Material::*)()  const>(&G4Material::GetIonisation));
  ...
  t43.method("GetSandiaTable", static_cast<G4SandiaTable * (G4Material::*)()  const>(&G4Material::GetSandiaTable));
  ...
  t43.method("GetBaseMaterial", static_cast<const G4Material * (G4Material::*)()  const>(&G4Material::GetBaseMaterial));
  ...
  t43.method("GetMassOfMolecule", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetMassOfMolecule));
  ...
  t43.method("SetChemicalFormula", static_cast<void (G4Material::*)(const G4String &) >(&G4Material::SetChemicalFormula));
  ...
  t43.method("SetFreeElectronDensity", static_cast<void (G4Material::*)(G4double) >(&G4Material::SetFreeElectronDensity));
  ...
  t43.method("ComputeDensityEffectOnFly", static_cast<void (G4Material::*)(G4bool) >(&G4Material::ComputeDensityEffectOnFly));
  ...
  t43.method("GetZ", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetZ));
  ...
  t43.method("GetA", static_cast<G4double (G4Material::*)()  const>(&G4Material::GetA));
  ...
  t43.method("SetMaterialPropertiesTable", static_cast<void (G4Material::*)(G4MaterialPropertiesTable *) >(&G4Material::SetMaterialPropertiesTable));
  ...
  t43.method("GetMaterialPropertiesTable", static_cast<G4MaterialPropertiesTable * (G4Material::*)()  const>(&G4Material::GetMaterialPropertiesTable));
  ...
  t43.method("GetIndex", static_cast<size_t (G4Material::*)()  const>(&G4Material::GetIndex));
  ...
  t43.method("G4Material!GetMaterialTable", static_cast<G4MaterialTable * (*)() >(&G4Material::GetMaterialTable));
  ...
  t43.method("G4Material!GetNumberOfMaterials", static_cast<size_t (*)() >(&G4Material::GetNumberOfMaterials));
  ...
  t43.method("G4Material!GetMaterial", static_cast<G4Material * (*)(const G4String &, G4bool) >(&G4Material::GetMaterial));
  t43.method("G4Material!GetMaterial", [](const G4String & arg0)->G4Material *{ return G4Material::GetMaterial(arg0); });
  ...
  t43.method("G4Material!GetMaterial", static_cast<G4Material * (*)(G4double, G4double, G4double) >(&G4Material::GetMaterial));
  ...
  t43.method("G4Material!GetMaterial", static_cast<G4Material * (*)(size_t, G4double) >(&G4Material::GetMaterial));
  ...
  t43.method("SetName", static_cast<void (G4Material::*)(const G4String &) >(&G4Material::SetName));
  ...
  t43.method("IsExtended", static_cast<G4bool (G4Material::*)()  const>(&G4Material::IsExtended));
