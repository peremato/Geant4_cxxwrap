...
void add_methods_for_G4Tet(jlcxx::Module& types, jlcxx::TypeWrapper<G4Tet>& t238) {
  ...
  t238.constructor<const G4String &, const G4ThreeVector &, const G4ThreeVector &, const G4ThreeVector &, const G4ThreeVector &>(/*finalize=*/true);
  t238.constructor<const G4String &, const G4ThreeVector &, const G4ThreeVector &, const G4ThreeVector &, const G4ThreeVector &, G4bool *>(/*finalize=*/true);
  ...
  t238.method("SetVertices", static_cast<void (G4Tet::*)(const G4ThreeVector &, const G4ThreeVector &, const G4ThreeVector &, const G4ThreeVector &, G4bool *) >(&G4Tet::SetVertices));
  t238.method("SetVertices", [](G4Tet& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4ThreeVector & arg2, const G4ThreeVector & arg3)->void{ a.SetVertices(arg0, arg1, arg2, arg3); });
  t238.method("SetVertices", [](G4Tet* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4ThreeVector & arg2, const G4ThreeVector & arg3)->void{ a->SetVertices(arg0, arg1, arg2, arg3); });
  ...
  t238.method("GetVertices", static_cast<void (G4Tet::*)(G4ThreeVector &, G4ThreeVector &, G4ThreeVector &, G4ThreeVector &)  const>(&G4Tet::GetVertices));
  ...
  t238.method("GetVertices", static_cast<std::vector<G4ThreeVector> (G4Tet::*)()  const>(&G4Tet::GetVertices));
  ...
  t238.method("PrintWarnings", static_cast<void (G4Tet::*)(G4bool) >(&G4Tet::PrintWarnings));
  ...
  t238.method("CheckDegeneracy", static_cast<G4bool (G4Tet::*)(const G4ThreeVector &, const G4ThreeVector &, const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Tet::CheckDegeneracy));
  ...
  t238.method("ComputeDimensions", static_cast<void (G4Tet::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4Tet::ComputeDimensions));
  ...
  t238.method("SetBoundingLimits", static_cast<void (G4Tet::*)(const G4ThreeVector &, const G4ThreeVector &) >(&G4Tet::SetBoundingLimits));
  ...
  t238.method("BoundingLimits", static_cast<void (G4Tet::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Tet::BoundingLimits));
  ...
  t238.method("Inside", static_cast<EInside (G4Tet::*)(const G4ThreeVector &)  const>(&G4Tet::Inside));
  ...
  t238.method("SurfaceNormal", static_cast<G4ThreeVector (G4Tet::*)(const G4ThreeVector &)  const>(&G4Tet::SurfaceNormal));
  ...
  t238.method("DistanceToIn", static_cast<G4double (G4Tet::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Tet::DistanceToIn));
  ...
  t238.method("DistanceToIn", static_cast<G4double (G4Tet::*)(const G4ThreeVector &)  const>(&G4Tet::DistanceToIn));
  ...
  t238.method("DistanceToOut", static_cast<G4double (G4Tet::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Tet::DistanceToOut));
  t238.method("DistanceToOut", [](G4Tet const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t238.method("DistanceToOut", [](G4Tet const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t238.method("DistanceToOut", [](G4Tet const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t238.method("DistanceToOut", [](G4Tet const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t238.method("DistanceToOut", [](G4Tet const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t238.method("DistanceToOut", [](G4Tet const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t238.method("DistanceToOut", static_cast<G4double (G4Tet::*)(const G4ThreeVector &)  const>(&G4Tet::DistanceToOut));
  ...
  t238.method("GetEntityType", static_cast<G4GeometryType (G4Tet::*)()  const>(&G4Tet::GetEntityType));
  ...
  t238.method("Clone", static_cast<G4VSolid * (G4Tet::*)()  const>(&G4Tet::Clone));
  ...
  t238.method("GetCubicVolume", static_cast<G4double (G4Tet::*)() >(&G4Tet::GetCubicVolume));
  ...
  t238.method("GetSurfaceArea", static_cast<G4double (G4Tet::*)() >(&G4Tet::GetSurfaceArea));
  ...
  t238.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Tet::*)()  const>(&G4Tet::GetPointOnSurface));
  ...
  t238.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Tet::*)()  const>(&G4Tet::CreatePolyhedron));
  ...
  t238.method("GetPolyhedron", static_cast<G4Polyhedron * (G4Tet::*)()  const>(&G4Tet::GetPolyhedron));
  ...
  t238.constructor<const G4Tet &>(/*finalize=*/true);
  ...
  t238.method("assign", static_cast<G4Tet & (G4Tet::*)(const G4Tet &) >(&G4Tet::operator=));
