...
void add_methods_for_G4ScoringManager(jlcxx::Module& types, jlcxx::TypeWrapper<G4ScoringManager>& t140) {
  ...
  t140.method("G4ScoringManager!GetScoringManager", static_cast<G4ScoringManager * (*)() >(&G4ScoringManager::GetScoringManager));
  ...
  t140.method("G4ScoringManager!GetScoringManagerIfExist", static_cast<G4ScoringManager * (*)() >(&G4ScoringManager::GetScoringManagerIfExist));
  ...
  t140.method("G4ScoringManager!SetReplicaLevel", static_cast<void (*)(G4int) >(&G4ScoringManager::SetReplicaLevel));
  ...
  t140.method("G4ScoringManager!GetReplicaLevel", static_cast<G4int (*)() >(&G4ScoringManager::GetReplicaLevel));
  ...
  t140.method("Accumulate", static_cast<void (G4ScoringManager::*)(G4VHitsCollection *) >(&G4ScoringManager::Accumulate));
  ...
  t140.method("Merge", static_cast<void (G4ScoringManager::*)(const G4ScoringManager *) >(&G4ScoringManager::Merge));
  ...
  t140.method("FindMesh", static_cast<G4VScoringMesh * (G4ScoringManager::*)(G4VHitsCollection *) >(&G4ScoringManager::FindMesh));
  ...
  t140.method("FindMesh", static_cast<G4VScoringMesh * (G4ScoringManager::*)(const G4String &) >(&G4ScoringManager::FindMesh));
  ...
  t140.method("List", static_cast<void (G4ScoringManager::*)()  const>(&G4ScoringManager::List));
  ...
  t140.method("Dump", static_cast<void (G4ScoringManager::*)()  const>(&G4ScoringManager::Dump));
  ...
  t140.method("DrawMesh", static_cast<void (G4ScoringManager::*)(const G4String &, const G4String &, const G4String &, G4int) >(&G4ScoringManager::DrawMesh));
  t140.method("DrawMesh", [](G4ScoringManager& a, const G4String & arg0, const G4String & arg1, const G4String & arg2)->void{ a.DrawMesh(arg0, arg1, arg2); });
  t140.method("DrawMesh", [](G4ScoringManager* a, const G4String & arg0, const G4String & arg1, const G4String & arg2)->void{ a->DrawMesh(arg0, arg1, arg2); });
  ...
  t140.method("DrawMesh", static_cast<void (G4ScoringManager::*)(const G4String &, const G4String &, G4int, G4int, const G4String &) >(&G4ScoringManager::DrawMesh));
  ...
  t140.method("DumpQuantityToFile", static_cast<void (G4ScoringManager::*)(const G4String &, const G4String &, const G4String &, const G4String &) >(&G4ScoringManager::DumpQuantityToFile));
  t140.method("DumpQuantityToFile", [](G4ScoringManager& a, const G4String & arg0, const G4String & arg1, const G4String & arg2)->void{ a.DumpQuantityToFile(arg0, arg1, arg2); });
  t140.method("DumpQuantityToFile", [](G4ScoringManager* a, const G4String & arg0, const G4String & arg1, const G4String & arg2)->void{ a->DumpQuantityToFile(arg0, arg1, arg2); });
  ...
  t140.method("DumpAllQuantitiesToFile", static_cast<void (G4ScoringManager::*)(const G4String &, const G4String &, const G4String &) >(&G4ScoringManager::DumpAllQuantitiesToFile));
  t140.method("DumpAllQuantitiesToFile", [](G4ScoringManager& a, const G4String & arg0, const G4String & arg1)->void{ a.DumpAllQuantitiesToFile(arg0, arg1); });
  t140.method("DumpAllQuantitiesToFile", [](G4ScoringManager* a, const G4String & arg0, const G4String & arg1)->void{ a->DumpAllQuantitiesToFile(arg0, arg1); });
  ...
  t140.method("ListScoreColorMaps", static_cast<void (G4ScoringManager::*)() >(&G4ScoringManager::ListScoreColorMaps));
  ...
  t140.method("SetCurrentMesh", static_cast<void (G4ScoringManager::*)(G4VScoringMesh *) >(&G4ScoringManager::SetCurrentMesh));
  ...
  t140.method("GetCurrentMesh", static_cast<G4VScoringMesh * (G4ScoringManager::*)()  const>(&G4ScoringManager::GetCurrentMesh));
  ...
  t140.method("CloseCurrentMesh", static_cast<void (G4ScoringManager::*)() >(&G4ScoringManager::CloseCurrentMesh));
  ...
  t140.method("SetVerboseLevel", static_cast<void (G4ScoringManager::*)(G4int) >(&G4ScoringManager::SetVerboseLevel));
  ...
  t140.method("GetVerboseLevel", static_cast<G4int (G4ScoringManager::*)()  const>(&G4ScoringManager::GetVerboseLevel));
  ...
  t140.method("GetNumberOfMesh", static_cast<size_t (G4ScoringManager::*)()  const>(&G4ScoringManager::GetNumberOfMesh));
  ...
  t140.method("RegisterScoringMesh", static_cast<void (G4ScoringManager::*)(G4VScoringMesh *) >(&G4ScoringManager::RegisterScoringMesh));
  ...
  t140.method("GetMesh", static_cast<G4VScoringMesh * (G4ScoringManager::*)(G4int)  const>(&G4ScoringManager::GetMesh));
  ...
  t140.method("GetWorldName", static_cast<G4String (G4ScoringManager::*)(G4int)  const>(&G4ScoringManager::GetWorldName));
  ...
  t140.method("SetScoreWriter", static_cast<void (G4ScoringManager::*)(G4VScoreWriter *) >(&G4ScoringManager::SetScoreWriter));
  ...
  t140.method("SetFactor", static_cast<void (G4ScoringManager::*)(G4double) >(&G4ScoringManager::SetFactor));
  t140.method("SetFactor", [](G4ScoringManager& a)->void{ a.SetFactor(); });
  t140.method("SetFactor", [](G4ScoringManager* a)->void{ a->SetFactor(); });
  ...
  t140.method("GetFactor", static_cast<G4double (G4ScoringManager::*)()  const>(&G4ScoringManager::GetFactor));
