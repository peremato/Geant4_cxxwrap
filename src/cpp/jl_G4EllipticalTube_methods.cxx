...
void add_methods_for_G4EllipticalTube(jlcxx::Module& types, jlcxx::TypeWrapper<G4EllipticalTube>& t195) {
  ...
  t195.constructor<const G4String &, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t195.method("BoundingLimits", static_cast<void (G4EllipticalTube::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4EllipticalTube::BoundingLimits));
  ...
  t195.method("Inside", static_cast<EInside (G4EllipticalTube::*)(const G4ThreeVector &)  const>(&G4EllipticalTube::Inside));
  ...
  t195.method("SurfaceNormal", static_cast<G4ThreeVector (G4EllipticalTube::*)(const G4ThreeVector &)  const>(&G4EllipticalTube::SurfaceNormal));
  ...
  t195.method("DistanceToIn", static_cast<G4double (G4EllipticalTube::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4EllipticalTube::DistanceToIn));
  ...
  t195.method("DistanceToIn", static_cast<G4double (G4EllipticalTube::*)(const G4ThreeVector &)  const>(&G4EllipticalTube::DistanceToIn));
  ...
  t195.method("DistanceToOut", static_cast<G4double (G4EllipticalTube::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4EllipticalTube::DistanceToOut));
  t195.method("DistanceToOut", [](G4EllipticalTube const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t195.method("DistanceToOut", [](G4EllipticalTube const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t195.method("DistanceToOut", [](G4EllipticalTube const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t195.method("DistanceToOut", [](G4EllipticalTube const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t195.method("DistanceToOut", [](G4EllipticalTube const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t195.method("DistanceToOut", [](G4EllipticalTube const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t195.method("DistanceToOut", static_cast<G4double (G4EllipticalTube::*)(const G4ThreeVector &)  const>(&G4EllipticalTube::DistanceToOut));
  ...
  t195.method("GetEntityType", static_cast<G4GeometryType (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetEntityType));
  ...
  t195.method("Clone", static_cast<G4VSolid * (G4EllipticalTube::*)()  const>(&G4EllipticalTube::Clone));
  ...
  t195.method("GetCubicVolume", static_cast<G4double (G4EllipticalTube::*)() >(&G4EllipticalTube::GetCubicVolume));
  ...
  t195.method("GetSurfaceArea", static_cast<G4double (G4EllipticalTube::*)() >(&G4EllipticalTube::GetSurfaceArea));
  ...
  t195.method("GetPointOnSurface", static_cast<G4ThreeVector (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetPointOnSurface));
  ...
  t195.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4EllipticalTube::*)()  const>(&G4EllipticalTube::CreatePolyhedron));
  ...
  t195.method("GetPolyhedron", static_cast<G4Polyhedron * (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetPolyhedron));
  ...
  t195.method("GetDx", static_cast<G4double (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetDx));
  ...
  t195.method("GetDy", static_cast<G4double (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetDy));
  ...
  t195.method("GetDz", static_cast<G4double (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetDz));
  ...
  t195.method("SetDx", static_cast<void (G4EllipticalTube::*)(G4double) >(&G4EllipticalTube::SetDx));
  ...
  t195.method("SetDy", static_cast<void (G4EllipticalTube::*)(G4double) >(&G4EllipticalTube::SetDy));
  ...
  t195.method("SetDz", static_cast<void (G4EllipticalTube::*)(G4double) >(&G4EllipticalTube::SetDz));
  ...
  t195.constructor<const G4EllipticalTube &>(/*finalize=*/true);
  ...
  t195.method("assign", static_cast<G4EllipticalTube & (G4EllipticalTube::*)(const G4EllipticalTube &) >(&G4EllipticalTube::operator=));
