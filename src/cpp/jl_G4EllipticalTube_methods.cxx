...
void add_methods_for_G4EllipticalTube(jlcxx::Module& types, jlcxx::TypeWrapper<G4EllipticalTube>& t194) {
  ...
  t194.constructor<const G4String &, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t194.method("BoundingLimits", static_cast<void (G4EllipticalTube::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4EllipticalTube::BoundingLimits));
  ...
  t194.method("Inside", static_cast<EInside (G4EllipticalTube::*)(const G4ThreeVector &)  const>(&G4EllipticalTube::Inside));
  ...
  t194.method("SurfaceNormal", static_cast<G4ThreeVector (G4EllipticalTube::*)(const G4ThreeVector &)  const>(&G4EllipticalTube::SurfaceNormal));
  ...
  t194.method("DistanceToIn", static_cast<G4double (G4EllipticalTube::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4EllipticalTube::DistanceToIn));
  ...
  t194.method("DistanceToIn", static_cast<G4double (G4EllipticalTube::*)(const G4ThreeVector &)  const>(&G4EllipticalTube::DistanceToIn));
  ...
  t194.method("DistanceToOut", static_cast<G4double (G4EllipticalTube::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4EllipticalTube::DistanceToOut));
  t194.method("DistanceToOut", [](G4EllipticalTube const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t194.method("DistanceToOut", [](G4EllipticalTube const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t194.method("DistanceToOut", [](G4EllipticalTube const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t194.method("DistanceToOut", [](G4EllipticalTube const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t194.method("DistanceToOut", [](G4EllipticalTube const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t194.method("DistanceToOut", [](G4EllipticalTube const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t194.method("DistanceToOut", static_cast<G4double (G4EllipticalTube::*)(const G4ThreeVector &)  const>(&G4EllipticalTube::DistanceToOut));
  ...
  t194.method("GetEntityType", static_cast<G4GeometryType (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetEntityType));
  ...
  t194.method("Clone", static_cast<G4VSolid * (G4EllipticalTube::*)()  const>(&G4EllipticalTube::Clone));
  ...
  t194.method("GetCubicVolume", static_cast<G4double (G4EllipticalTube::*)() >(&G4EllipticalTube::GetCubicVolume));
  ...
  t194.method("GetSurfaceArea", static_cast<G4double (G4EllipticalTube::*)() >(&G4EllipticalTube::GetSurfaceArea));
  ...
  t194.method("GetPointOnSurface", static_cast<G4ThreeVector (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetPointOnSurface));
  ...
  t194.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4EllipticalTube::*)()  const>(&G4EllipticalTube::CreatePolyhedron));
  ...
  t194.method("GetPolyhedron", static_cast<G4Polyhedron * (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetPolyhedron));
  ...
  t194.method("GetDx", static_cast<G4double (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetDx));
  ...
  t194.method("GetDy", static_cast<G4double (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetDy));
  ...
  t194.method("GetDz", static_cast<G4double (G4EllipticalTube::*)()  const>(&G4EllipticalTube::GetDz));
  ...
  t194.method("SetDx", static_cast<void (G4EllipticalTube::*)(G4double) >(&G4EllipticalTube::SetDx));
  ...
  t194.method("SetDy", static_cast<void (G4EllipticalTube::*)(G4double) >(&G4EllipticalTube::SetDy));
  ...
  t194.method("SetDz", static_cast<void (G4EllipticalTube::*)(G4double) >(&G4EllipticalTube::SetDz));
  ...
  t194.constructor<const G4EllipticalTube &>(/*finalize=*/true);
  ...
  t194.method("assign", static_cast<G4EllipticalTube & (G4EllipticalTube::*)(const G4EllipticalTube &) >(&G4EllipticalTube::operator=));
