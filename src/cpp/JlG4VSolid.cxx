...
struct JlG4VSolid: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.method("GetNumOfConstituents", static_cast<G4int (G4VSolid::*)()  const>(&G4VSolid::GetNumOfConstituents));
    ...
    t.method("IsFaceted", static_cast<G4bool (G4VSolid::*)()  const>(&G4VSolid::IsFaceted));
