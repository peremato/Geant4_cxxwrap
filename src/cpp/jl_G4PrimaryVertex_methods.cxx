...
void add_methods_for_G4PrimaryVertex(jlcxx::Module& types, jlcxx::TypeWrapper<G4PrimaryVertex>& t97) {
  ...
  t97.constructor<G4double, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t97.constructor<G4ThreeVector, G4double>(/*finalize=*/true);
  ...
  t97.constructor<const G4PrimaryVertex &>(/*finalize=*/true);
  ...
  t97.method("assign", static_cast<G4PrimaryVertex & (G4PrimaryVertex::*)(const G4PrimaryVertex &) >(&G4PrimaryVertex::operator=));
  ...
  t97.method("==", static_cast<G4bool (G4PrimaryVertex::*)(const G4PrimaryVertex &)  const>(&G4PrimaryVertex::operator==));
  ...
  t97.method("GetPosition", static_cast<G4ThreeVector (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetPosition));
  ...
  t97.method("SetPosition", static_cast<void (G4PrimaryVertex::*)(G4double, G4double, G4double) >(&G4PrimaryVertex::SetPosition));
  ...
  t97.method("GetX0", static_cast<G4double (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetX0));
  ...
  t97.method("GetY0", static_cast<G4double (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetY0));
  ...
  t97.method("GetZ0", static_cast<G4double (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetZ0));
  ...
  t97.method("GetT0", static_cast<G4double (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetT0));
  ...
  t97.method("SetT0", static_cast<void (G4PrimaryVertex::*)(G4double) >(&G4PrimaryVertex::SetT0));
  ...
  t97.method("GetNumberOfParticle", static_cast<G4int (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetNumberOfParticle));
  ...
  t97.method("SetPrimary", static_cast<void (G4PrimaryVertex::*)(G4PrimaryParticle *) >(&G4PrimaryVertex::SetPrimary));
  ...
  t97.method("GetPrimary", static_cast<G4PrimaryParticle * (G4PrimaryVertex::*)(G4int)  const>(&G4PrimaryVertex::GetPrimary));
  t97.method("GetPrimary", [](G4PrimaryVertex const& a)->G4PrimaryParticle *{ return a.GetPrimary(); });
  t97.method("GetPrimary", [](G4PrimaryVertex const* a)->G4PrimaryParticle *{ return a->GetPrimary(); });
  ...
  t97.method("SetNext", static_cast<void (G4PrimaryVertex::*)(G4PrimaryVertex *) >(&G4PrimaryVertex::SetNext));
  ...
  t97.method("ClearNext", static_cast<void (G4PrimaryVertex::*)() >(&G4PrimaryVertex::ClearNext));
  ...
  t97.method("GetNext", static_cast<G4PrimaryVertex * (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetNext));
  ...
  t97.method("GetWeight", static_cast<G4double (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetWeight));
  ...
  t97.method("SetWeight", static_cast<void (G4PrimaryVertex::*)(G4double) >(&G4PrimaryVertex::SetWeight));
  ...
  t97.method("Print", static_cast<void (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::Print));
