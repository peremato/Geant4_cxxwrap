...
void add_methods_for_G4PrimaryVertex(jlcxx::Module& types, jlcxx::TypeWrapper<G4PrimaryVertex>& t99) {
  ...
  t99.constructor<G4double, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t99.constructor<G4ThreeVector, G4double>(/*finalize=*/true);
  ...
  t99.constructor<const G4PrimaryVertex &>(/*finalize=*/true);
  ...
  t99.method("assign", static_cast<G4PrimaryVertex & (G4PrimaryVertex::*)(const G4PrimaryVertex &) >(&G4PrimaryVertex::operator=));
  ...
  t99.method("==", static_cast<G4bool (G4PrimaryVertex::*)(const G4PrimaryVertex &)  const>(&G4PrimaryVertex::operator==));
  ...
  t99.method("GetPosition", static_cast<G4ThreeVector (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetPosition));
  ...
  t99.method("SetPosition", static_cast<void (G4PrimaryVertex::*)(G4double, G4double, G4double) >(&G4PrimaryVertex::SetPosition));
  ...
  t99.method("GetX0", static_cast<G4double (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetX0));
  ...
  t99.method("GetY0", static_cast<G4double (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetY0));
  ...
  t99.method("GetZ0", static_cast<G4double (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetZ0));
  ...
  t99.method("GetT0", static_cast<G4double (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetT0));
  ...
  t99.method("SetT0", static_cast<void (G4PrimaryVertex::*)(G4double) >(&G4PrimaryVertex::SetT0));
  ...
  t99.method("GetNumberOfParticle", static_cast<G4int (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetNumberOfParticle));
  ...
  t99.method("SetPrimary", static_cast<void (G4PrimaryVertex::*)(G4PrimaryParticle *) >(&G4PrimaryVertex::SetPrimary));
  ...
  t99.method("GetPrimary", static_cast<G4PrimaryParticle * (G4PrimaryVertex::*)(G4int)  const>(&G4PrimaryVertex::GetPrimary));
  t99.method("GetPrimary", [](G4PrimaryVertex const& a)->G4PrimaryParticle *{ return a.GetPrimary(); });
  t99.method("GetPrimary", [](G4PrimaryVertex const* a)->G4PrimaryParticle *{ return a->GetPrimary(); });
  ...
  t99.method("SetNext", static_cast<void (G4PrimaryVertex::*)(G4PrimaryVertex *) >(&G4PrimaryVertex::SetNext));
  ...
  t99.method("ClearNext", static_cast<void (G4PrimaryVertex::*)() >(&G4PrimaryVertex::ClearNext));
  ...
  t99.method("GetNext", static_cast<G4PrimaryVertex * (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetNext));
  ...
  t99.method("GetWeight", static_cast<G4double (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::GetWeight));
  ...
  t99.method("SetWeight", static_cast<void (G4PrimaryVertex::*)(G4double) >(&G4PrimaryVertex::SetWeight));
  ...
  t99.method("Print", static_cast<void (G4PrimaryVertex::*)()  const>(&G4PrimaryVertex::Print));
