...
struct JlG4Event: public Wrapper {
  ...
  void add_methods() const{
    ...
    t.method("KeepTheEvent", static_cast<void (G4Event::*)(G4bool)  const>(&G4Event::KeepTheEvent));
    t.method("KeepTheEvent", [](G4Event const& a)->void { a.KeepTheEvent(); });
    t.method("KeepTheEvent", [](G4Event const* a)->void { a->KeepTheEvent(); });
    ...
    t.method("KeepTheEventFlag", static_cast<G4bool (G4Event::*)()  const>(&G4Event::KeepTheEventFlag));
    ...
    t.method("GetNumberOfCompletedSubEvent", static_cast<G4int (G4Event::*)()  const>(&G4Event::GetNumberOfCompletedSubEvent));
    ...
    t.method("ScoresRecorded", static_cast<void (G4Event::*)()  const>(&G4Event::ScoresRecorded));
    ...
    t.method("ScoresAlreadyRecorded", static_cast<G4bool (G4Event::*)()  const>(&G4Event::ScoresAlreadyRecorded));
    ...
    t.method("EventCompleted", static_cast<void (G4Event::*)()  const>(&G4Event::EventCompleted));
    ...
    t.method("IsEventCompleted", static_cast<G4bool (G4Event::*)()  const>(&G4Event::IsEventCompleted));
  }
