...
void add_methods_for_G4TouchableHistory(jlcxx::Module& types, jlcxx::TypeWrapper<G4TouchableHistory>& t86) {
  ...
  t86.constructor<const G4NavigationHistory &>(/*finalize=*/true);
  ...
  t86.method("GetVolume", static_cast<G4VPhysicalVolume * (G4TouchableHistory::*)(G4int)  const>(&G4TouchableHistory::GetVolume));
  t86.method("GetVolume", [](G4TouchableHistory const& a)->G4VPhysicalVolume *{ return a.GetVolume(); });
  t86.method("GetVolume", [](G4TouchableHistory const* a)->G4VPhysicalVolume *{ return a->GetVolume(); });
  ...
  t86.method("GetSolid", static_cast<G4VSolid * (G4TouchableHistory::*)(G4int)  const>(&G4TouchableHistory::GetSolid));
  t86.method("GetSolid", [](G4TouchableHistory const& a)->G4VSolid *{ return a.GetSolid(); });
  t86.method("GetSolid", [](G4TouchableHistory const* a)->G4VSolid *{ return a->GetSolid(); });
  ...
  t86.method("GetTranslation", static_cast<const G4ThreeVector & (G4TouchableHistory::*)(G4int)  const>(&G4TouchableHistory::GetTranslation));
  t86.method("GetTranslation", [](G4TouchableHistory const& a)->const G4ThreeVector &{ return a.GetTranslation(); });
  t86.method("GetTranslation", [](G4TouchableHistory const* a)->const G4ThreeVector &{ return a->GetTranslation(); });
  ...
  t86.method("GetRotation", static_cast<const G4RotationMatrix * (G4TouchableHistory::*)(G4int)  const>(&G4TouchableHistory::GetRotation));
  t86.method("GetRotation", [](G4TouchableHistory const& a)->const G4RotationMatrix *{ return a.GetRotation(); });
  t86.method("GetRotation", [](G4TouchableHistory const* a)->const G4RotationMatrix *{ return a->GetRotation(); });
  ...
  t86.method("GetReplicaNumber", static_cast<G4int (G4TouchableHistory::*)(G4int)  const>(&G4TouchableHistory::GetReplicaNumber));
  t86.method("GetReplicaNumber", [](G4TouchableHistory const& a)->G4int{ return a.GetReplicaNumber(); });
  t86.method("GetReplicaNumber", [](G4TouchableHistory const* a)->G4int{ return a->GetReplicaNumber(); });
  ...
  t86.method("GetHistoryDepth", static_cast<G4int (G4TouchableHistory::*)()  const>(&G4TouchableHistory::GetHistoryDepth));
  ...
  t86.method("MoveUpHistory", static_cast<G4int (G4TouchableHistory::*)(G4int) >(&G4TouchableHistory::MoveUpHistory));
  t86.method("MoveUpHistory", [](G4TouchableHistory& a)->G4int{ return a.MoveUpHistory(); });
  t86.method("MoveUpHistory", [](G4TouchableHistory* a)->G4int{ return a->MoveUpHistory(); });
  ...
  t86.method("UpdateYourself", static_cast<void (G4TouchableHistory::*)(G4VPhysicalVolume *, const G4NavigationHistory *) >(&G4TouchableHistory::UpdateYourself));
  t86.method("UpdateYourself", [](G4TouchableHistory& a, G4VPhysicalVolume * arg0)->void{ a.UpdateYourself(arg0); });
  t86.method("UpdateYourself", [](G4TouchableHistory* a, G4VPhysicalVolume * arg0)->void{ a->UpdateYourself(arg0); });
  ...
  t86.method("GetHistory", static_cast<const G4NavigationHistory * (G4TouchableHistory::*)()  const>(&G4TouchableHistory::GetHistory));
