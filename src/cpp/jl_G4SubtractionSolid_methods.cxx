...
void add_methods_for_G4SubtractionSolid(jlcxx::Module& types, jlcxx::TypeWrapper<G4SubtractionSolid>& t184) {
  ...
  t184.constructor<const G4String &, G4VSolid *, G4VSolid *>(/*finalize=*/true);
  ...
  t184.constructor<const G4String &, G4VSolid *, G4VSolid *, G4RotationMatrix *, const G4ThreeVector &>(/*finalize=*/true);
  ...
  t184.constructor<const G4String &, G4VSolid *, G4VSolid *, const G4Transform3D &>(/*finalize=*/true);
  ...
  t184.method("GetEntityType", static_cast<G4GeometryType (G4SubtractionSolid::*)()  const>(&G4SubtractionSolid::GetEntityType));
  ...
  t184.method("Clone", static_cast<G4VSolid * (G4SubtractionSolid::*)()  const>(&G4SubtractionSolid::Clone));
  ...
  t184.constructor<const G4SubtractionSolid &>(/*finalize=*/true);
  ...
  t184.method("assign", static_cast<G4SubtractionSolid & (G4SubtractionSolid::*)(const G4SubtractionSolid &) >(&G4SubtractionSolid::operator=));
  ...
  t184.method("BoundingLimits", static_cast<void (G4SubtractionSolid::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4SubtractionSolid::BoundingLimits));
  ...
  t184.method("Inside", static_cast<EInside (G4SubtractionSolid::*)(const G4ThreeVector &)  const>(&G4SubtractionSolid::Inside));
  ...
  t184.method("SurfaceNormal", static_cast<G4ThreeVector (G4SubtractionSolid::*)(const G4ThreeVector &)  const>(&G4SubtractionSolid::SurfaceNormal));
  ...
  t184.method("DistanceToIn", static_cast<G4double (G4SubtractionSolid::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4SubtractionSolid::DistanceToIn));
  ...
  t184.method("DistanceToIn", static_cast<G4double (G4SubtractionSolid::*)(const G4ThreeVector &)  const>(&G4SubtractionSolid::DistanceToIn));
  ...
  t184.method("DistanceToOut", static_cast<G4double (G4SubtractionSolid::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4SubtractionSolid::DistanceToOut));
  t184.method("DistanceToOut", [](G4SubtractionSolid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t184.method("DistanceToOut", [](G4SubtractionSolid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t184.method("DistanceToOut", [](G4SubtractionSolid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t184.method("DistanceToOut", [](G4SubtractionSolid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t184.method("DistanceToOut", [](G4SubtractionSolid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t184.method("DistanceToOut", [](G4SubtractionSolid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t184.method("DistanceToOut", static_cast<G4double (G4SubtractionSolid::*)(const G4ThreeVector &)  const>(&G4SubtractionSolid::DistanceToOut));
  ...
  t184.method("ComputeDimensions", static_cast<void (G4SubtractionSolid::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4SubtractionSolid::ComputeDimensions));
  ...
  t184.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4SubtractionSolid::*)()  const>(&G4SubtractionSolid::CreatePolyhedron));
  ...
  t184.method("GetCubicVolume", static_cast<G4double (G4SubtractionSolid::*)() >(&G4SubtractionSolid::GetCubicVolume));
