...
void add_methods_for_HepGeom_Translate3D(jlcxx::Module& types, jlcxx::TypeWrapper<HepGeom::Translate3D>& t71) {
  ...
  t71.constructor<const CLHEP::Hep3Vector &>(/*finalize=*/true);
  ...
  t71.constructor<double, double, double>(/*finalize=*/true);
