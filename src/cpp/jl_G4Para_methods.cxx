...
void add_methods_for_G4Para(jlcxx::Module& types, jlcxx::TypeWrapper<G4Para>& t176) {
  ...
  t176.constructor<const G4String &, G4double, G4double, G4double, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t176.method("GetZHalfLength", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetZHalfLength));
  ...
  t176.method("GetSymAxis", static_cast<G4ThreeVector (G4Para::*)()  const>(&G4Para::GetSymAxis));
  ...
  t176.method("GetYHalfLength", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetYHalfLength));
  ...
  t176.method("GetXHalfLength", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetXHalfLength));
  ...
  t176.method("GetTanAlpha", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetTanAlpha));
  ...
  t176.method("GetAlpha", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetAlpha));
  ...
  t176.method("GetTheta", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetTheta));
  ...
  t176.method("GetPhi", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetPhi));
  ...
  t176.method("SetXHalfLength", static_cast<void (G4Para::*)(G4double) >(&G4Para::SetXHalfLength));
  ...
  t176.method("SetYHalfLength", static_cast<void (G4Para::*)(G4double) >(&G4Para::SetYHalfLength));
  ...
  t176.method("SetZHalfLength", static_cast<void (G4Para::*)(G4double) >(&G4Para::SetZHalfLength));
  ...
  t176.method("SetAlpha", static_cast<void (G4Para::*)(G4double) >(&G4Para::SetAlpha));
  ...
  t176.method("SetTanAlpha", static_cast<void (G4Para::*)(G4double) >(&G4Para::SetTanAlpha));
  ...
  t176.method("SetThetaAndPhi", static_cast<void (G4Para::*)(double, double) >(&G4Para::SetThetaAndPhi));
  ...
  t176.method("SetAllParameters", static_cast<void (G4Para::*)(G4double, G4double, G4double, G4double, G4double, G4double) >(&G4Para::SetAllParameters));
  ...
  t176.method("GetCubicVolume", static_cast<G4double (G4Para::*)() >(&G4Para::GetCubicVolume));
  ...
  t176.method("GetSurfaceArea", static_cast<G4double (G4Para::*)() >(&G4Para::GetSurfaceArea));
  ...
  t176.method("ComputeDimensions", static_cast<void (G4Para::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4Para::ComputeDimensions));
  ...
  t176.method("BoundingLimits", static_cast<void (G4Para::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Para::BoundingLimits));
  ...
  t176.method("Inside", static_cast<EInside (G4Para::*)(const G4ThreeVector &)  const>(&G4Para::Inside));
  ...
  t176.method("SurfaceNormal", static_cast<G4ThreeVector (G4Para::*)(const G4ThreeVector &)  const>(&G4Para::SurfaceNormal));
  ...
  t176.method("DistanceToIn", static_cast<G4double (G4Para::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Para::DistanceToIn));
  ...
  t176.method("DistanceToIn", static_cast<G4double (G4Para::*)(const G4ThreeVector &)  const>(&G4Para::DistanceToIn));
  ...
  t176.method("DistanceToOut", static_cast<G4double (G4Para::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Para::DistanceToOut));
  t176.method("DistanceToOut", [](G4Para const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t176.method("DistanceToOut", [](G4Para const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t176.method("DistanceToOut", [](G4Para const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t176.method("DistanceToOut", [](G4Para const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t176.method("DistanceToOut", [](G4Para const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t176.method("DistanceToOut", [](G4Para const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t176.method("DistanceToOut", static_cast<G4double (G4Para::*)(const G4ThreeVector &)  const>(&G4Para::DistanceToOut));
  ...
  t176.method("GetEntityType", static_cast<G4GeometryType (G4Para::*)()  const>(&G4Para::GetEntityType));
  ...
  t176.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Para::*)()  const>(&G4Para::GetPointOnSurface));
  ...
  t176.method("Clone", static_cast<G4VSolid * (G4Para::*)()  const>(&G4Para::Clone));
  ...
  t176.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Para::*)()  const>(&G4Para::CreatePolyhedron));
  ...
  t176.constructor<const G4Para &>(/*finalize=*/true);
  ...
  t176.method("assign", static_cast<G4Para & (G4Para::*)(const G4Para &) >(&G4Para::operator=));
