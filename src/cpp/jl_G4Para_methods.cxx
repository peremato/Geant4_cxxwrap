...
void add_methods_for_G4Para(jlcxx::Module& types, jlcxx::TypeWrapper<G4Para>& t193) {
  ...
  t193.method("GetZHalfLength", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetZHalfLength));
  ...
  t193.method("GetSymAxis", static_cast<G4ThreeVector (G4Para::*)()  const>(&G4Para::GetSymAxis));
  ...
  t193.method("GetYHalfLength", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetYHalfLength));
  ...
  t193.method("GetXHalfLength", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetXHalfLength));
  ...
  t193.method("GetTanAlpha", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetTanAlpha));
  ...
  t193.method("GetAlpha", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetAlpha));
  ...
  t193.method("GetTheta", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetTheta));
  ...
  t193.method("GetPhi", static_cast<G4double (G4Para::*)()  const>(&G4Para::GetPhi));
  ...
  t193.method("SetXHalfLength", static_cast<void (G4Para::*)(G4double) >(&G4Para::SetXHalfLength));
  ...
  t193.method("SetYHalfLength", static_cast<void (G4Para::*)(G4double) >(&G4Para::SetYHalfLength));
  ...
  t193.method("SetZHalfLength", static_cast<void (G4Para::*)(G4double) >(&G4Para::SetZHalfLength));
  ...
  t193.method("SetAlpha", static_cast<void (G4Para::*)(G4double) >(&G4Para::SetAlpha));
  ...
  t193.method("SetTanAlpha", static_cast<void (G4Para::*)(G4double) >(&G4Para::SetTanAlpha));
  ...
  t193.method("SetThetaAndPhi", static_cast<void (G4Para::*)(double, double) >(&G4Para::SetThetaAndPhi));
  ...
  t193.method("SetAllParameters", static_cast<void (G4Para::*)(G4double, G4double, G4double, G4double, G4double, G4double) >(&G4Para::SetAllParameters));
  ...
  t193.method("GetCubicVolume", static_cast<G4double (G4Para::*)() >(&G4Para::GetCubicVolume));
  ...
  t193.method("GetSurfaceArea", static_cast<G4double (G4Para::*)() >(&G4Para::GetSurfaceArea));
  ...
  t193.method("ComputeDimensions", static_cast<void (G4Para::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4Para::ComputeDimensions));
  ...
  t193.method("BoundingLimits", static_cast<void (G4Para::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Para::BoundingLimits));
  ...
  t193.method("Inside", static_cast<EInside (G4Para::*)(const G4ThreeVector &)  const>(&G4Para::Inside));
  ...
  t193.method("SurfaceNormal", static_cast<G4ThreeVector (G4Para::*)(const G4ThreeVector &)  const>(&G4Para::SurfaceNormal));
  ...
  t193.method("DistanceToIn", static_cast<G4double (G4Para::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Para::DistanceToIn));
  ...
  t193.method("DistanceToIn", static_cast<G4double (G4Para::*)(const G4ThreeVector &)  const>(&G4Para::DistanceToIn));
  ...
  t193.method("DistanceToOut", static_cast<G4double (G4Para::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Para::DistanceToOut));
  t193.method("DistanceToOut", [](G4Para const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t193.method("DistanceToOut", [](G4Para const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t193.method("DistanceToOut", [](G4Para const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t193.method("DistanceToOut", [](G4Para const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t193.method("DistanceToOut", [](G4Para const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t193.method("DistanceToOut", [](G4Para const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t193.method("DistanceToOut", static_cast<G4double (G4Para::*)(const G4ThreeVector &)  const>(&G4Para::DistanceToOut));
  ...
  t193.method("GetEntityType", static_cast<G4GeometryType (G4Para::*)()  const>(&G4Para::GetEntityType));
  ...
  t193.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Para::*)()  const>(&G4Para::GetPointOnSurface));
  ...
  t193.method("Clone", static_cast<G4VSolid * (G4Para::*)()  const>(&G4Para::Clone));
  ...
  t193.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Para::*)()  const>(&G4Para::CreatePolyhedron));
  ...
  t193.constructor<const G4Para &>(/*finalize=*/true);
  ...
  t193.method("assign", static_cast<G4Para & (G4Para::*)(const G4Para &) >(&G4Para::operator=));
