...
void add_methods_for_G4VCSGfaceted(jlcxx::Module& types, jlcxx::TypeWrapper<G4VCSGfaceted>& t182) {
  ...
  t182.method("assign", static_cast<G4VCSGfaceted & (G4VCSGfaceted::*)(const G4VCSGfaceted &) >(&G4VCSGfaceted::operator=));
  ...
  t182.method("Inside", static_cast<EInside (G4VCSGfaceted::*)(const G4ThreeVector &)  const>(&G4VCSGfaceted::Inside));
  ...
  t182.method("SurfaceNormal", static_cast<G4ThreeVector (G4VCSGfaceted::*)(const G4ThreeVector &)  const>(&G4VCSGfaceted::SurfaceNormal));
  ...
  t182.method("DistanceToIn", static_cast<G4double (G4VCSGfaceted::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4VCSGfaceted::DistanceToIn));
  ...
  t182.method("DistanceToIn", static_cast<G4double (G4VCSGfaceted::*)(const G4ThreeVector &)  const>(&G4VCSGfaceted::DistanceToIn));
  ...
  t182.method("DistanceToOut", static_cast<G4double (G4VCSGfaceted::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4VCSGfaceted::DistanceToOut));
  t182.method("DistanceToOut", [](G4VCSGfaceted const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t182.method("DistanceToOut", [](G4VCSGfaceted const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t182.method("DistanceToOut", [](G4VCSGfaceted const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t182.method("DistanceToOut", [](G4VCSGfaceted const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t182.method("DistanceToOut", [](G4VCSGfaceted const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t182.method("DistanceToOut", [](G4VCSGfaceted const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t182.method("DistanceToOut", static_cast<G4double (G4VCSGfaceted::*)(const G4ThreeVector &)  const>(&G4VCSGfaceted::DistanceToOut));
  ...
  t182.method("GetEntityType", static_cast<G4GeometryType (G4VCSGfaceted::*)()  const>(&G4VCSGfaceted::GetEntityType));
  ...
  t182.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4VCSGfaceted::*)()  const>(&G4VCSGfaceted::CreatePolyhedron));
  ...
  t182.method("GetPolyhedron", static_cast<G4Polyhedron * (G4VCSGfaceted::*)()  const>(&G4VCSGfaceted::GetPolyhedron));
  ...
  t182.method("GetCubVolStatistics", static_cast<G4int (G4VCSGfaceted::*)()  const>(&G4VCSGfaceted::GetCubVolStatistics));
  ...
  t182.method("GetCubVolEpsilon", static_cast<G4double (G4VCSGfaceted::*)()  const>(&G4VCSGfaceted::GetCubVolEpsilon));
  ...
  t182.method("SetCubVolStatistics", static_cast<void (G4VCSGfaceted::*)(G4int) >(&G4VCSGfaceted::SetCubVolStatistics));
  ...
  t182.method("SetCubVolEpsilon", static_cast<void (G4VCSGfaceted::*)(G4double) >(&G4VCSGfaceted::SetCubVolEpsilon));
  ...
  t182.method("GetAreaStatistics", static_cast<G4int (G4VCSGfaceted::*)()  const>(&G4VCSGfaceted::GetAreaStatistics));
  ...
  t182.method("GetAreaAccuracy", static_cast<G4double (G4VCSGfaceted::*)()  const>(&G4VCSGfaceted::GetAreaAccuracy));
  ...
  t182.method("SetAreaStatistics", static_cast<void (G4VCSGfaceted::*)(G4int) >(&G4VCSGfaceted::SetAreaStatistics));
  ...
  t182.method("SetAreaAccuracy", static_cast<void (G4VCSGfaceted::*)(G4double) >(&G4VCSGfaceted::SetAreaAccuracy));
  ...
  t182.method("GetCubicVolume", static_cast<G4double (G4VCSGfaceted::*)() >(&G4VCSGfaceted::GetCubicVolume));
  ...
  t182.method("GetSurfaceArea", static_cast<G4double (G4VCSGfaceted::*)() >(&G4VCSGfaceted::GetSurfaceArea));
