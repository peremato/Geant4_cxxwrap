...
void add_methods_for_G4JLActionInitialization(jlcxx::Module& types, jlcxx::TypeWrapper<G4JLActionInitialization>& t109) {
  ...
  // defined in ./cpp/Geant4Wrap.h:92:5
  t109.constructor<build_f, void *>(/*finalize=*/true);
  t109.constructor<build_f, void *, build_f>(/*finalize=*/true);
  t109.constructor<build_f, void *, build_f, void *>(/*finalize=*/true);
  ...
  t109.method("BuildForMaster", static_cast<void (G4JLActionInitialization::*)()  const>(&G4JLActionInitialization::BuildForMaster));
  ...
  t109.method("Build", static_cast<void (G4JLActionInitialization::*)()  const>(&G4JLActionInitialization::Build));
  ...
  t109.method("SetUserAction", static_cast<void (G4JLActionInitialization::*)(G4VUserPrimaryGeneratorAction *)  const>(&G4JLActionInitialization::SetUserAction));
  ...
  t109.method("SetUserAction", static_cast<void (G4JLActionInitialization::*)(G4UserRunAction *)  const>(&G4JLActionInitialization::SetUserAction));
  ...
  t109.method("SetUserAction", static_cast<void (G4JLActionInitialization::*)(G4UserEventAction *)  const>(&G4JLActionInitialization::SetUserAction));
  ...
  t109.method("SetUserAction", static_cast<void (G4JLActionInitialization::*)(G4UserStackingAction *)  const>(&G4JLActionInitialization::SetUserAction));
  ...
  t109.method("SetUserAction", static_cast<void (G4JLActionInitialization::*)(G4UserTrackingAction *)  const>(&G4JLActionInitialization::SetUserAction));
  ...
  t109.method("SetUserAction", static_cast<void (G4JLActionInitialization::*)(G4UserSteppingAction *)  const>(&G4JLActionInitialization::SetUserAction));
