...
void add_methods_for_G4CutTubs(jlcxx::Module& types, jlcxx::TypeWrapper<G4CutTubs>& t193) {
  ...
  t193.constructor<const G4String &, G4double, G4double, G4double, G4double, G4double, G4ThreeVector, G4ThreeVector>(/*finalize=*/true);
  ...
  t193.method("GetInnerRadius", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetInnerRadius));
  ...
  t193.method("GetOuterRadius", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetOuterRadius));
  ...
  t193.method("GetZHalfLength", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetZHalfLength));
  ...
  t193.method("GetStartPhiAngle", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetStartPhiAngle));
  ...
  t193.method("GetDeltaPhiAngle", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetDeltaPhiAngle));
  ...
  t193.method("GetSinStartPhi", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetSinStartPhi));
  ...
  t193.method("GetCosStartPhi", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetCosStartPhi));
  ...
  t193.method("GetSinEndPhi", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetSinEndPhi));
  ...
  t193.method("GetCosEndPhi", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetCosEndPhi));
  ...
  t193.method("GetLowNorm", static_cast<G4ThreeVector (G4CutTubs::*)()  const>(&G4CutTubs::GetLowNorm));
  ...
  t193.method("GetHighNorm", static_cast<G4ThreeVector (G4CutTubs::*)()  const>(&G4CutTubs::GetHighNorm));
  ...
  t193.method("SetInnerRadius", static_cast<void (G4CutTubs::*)(G4double) >(&G4CutTubs::SetInnerRadius));
  ...
  t193.method("SetOuterRadius", static_cast<void (G4CutTubs::*)(G4double) >(&G4CutTubs::SetOuterRadius));
  ...
  t193.method("SetZHalfLength", static_cast<void (G4CutTubs::*)(G4double) >(&G4CutTubs::SetZHalfLength));
  ...
  t193.method("SetStartPhiAngle", static_cast<void (G4CutTubs::*)(G4double, G4bool) >(&G4CutTubs::SetStartPhiAngle));
  t193.method("SetStartPhiAngle", [](G4CutTubs& a, G4double arg0)->void{ a.SetStartPhiAngle(arg0); });
  t193.method("SetStartPhiAngle", [](G4CutTubs* a, G4double arg0)->void{ a->SetStartPhiAngle(arg0); });
  ...
  t193.method("SetDeltaPhiAngle", static_cast<void (G4CutTubs::*)(G4double) >(&G4CutTubs::SetDeltaPhiAngle));
  ...
  t193.method("GetCubicVolume", static_cast<G4double (G4CutTubs::*)() >(&G4CutTubs::GetCubicVolume));
  ...
  t193.method("GetSurfaceArea", static_cast<G4double (G4CutTubs::*)() >(&G4CutTubs::GetSurfaceArea));
  ...
  t193.method("BoundingLimits", static_cast<void (G4CutTubs::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4CutTubs::BoundingLimits));
  ...
  t193.method("Inside", static_cast<EInside (G4CutTubs::*)(const G4ThreeVector &)  const>(&G4CutTubs::Inside));
  ...
  t193.method("SurfaceNormal", static_cast<G4ThreeVector (G4CutTubs::*)(const G4ThreeVector &)  const>(&G4CutTubs::SurfaceNormal));
  ...
  t193.method("DistanceToIn", static_cast<G4double (G4CutTubs::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4CutTubs::DistanceToIn));
  ...
  t193.method("DistanceToIn", static_cast<G4double (G4CutTubs::*)(const G4ThreeVector &)  const>(&G4CutTubs::DistanceToIn));
  ...
  t193.method("DistanceToOut", static_cast<G4double (G4CutTubs::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4CutTubs::DistanceToOut));
  t193.method("DistanceToOut", [](G4CutTubs const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t193.method("DistanceToOut", [](G4CutTubs const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t193.method("DistanceToOut", [](G4CutTubs const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t193.method("DistanceToOut", [](G4CutTubs const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t193.method("DistanceToOut", [](G4CutTubs const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t193.method("DistanceToOut", [](G4CutTubs const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t193.method("DistanceToOut", static_cast<G4double (G4CutTubs::*)(const G4ThreeVector &)  const>(&G4CutTubs::DistanceToOut));
  ...
  t193.method("GetEntityType", static_cast<G4GeometryType (G4CutTubs::*)()  const>(&G4CutTubs::GetEntityType));
  ...
  t193.method("GetPointOnSurface", static_cast<G4ThreeVector (G4CutTubs::*)()  const>(&G4CutTubs::GetPointOnSurface));
  ...
  t193.method("Clone", static_cast<G4VSolid * (G4CutTubs::*)()  const>(&G4CutTubs::Clone));
  ...
  t193.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4CutTubs::*)()  const>(&G4CutTubs::CreatePolyhedron));
  ...
  t193.constructor<const G4CutTubs &>(/*finalize=*/true);
  ...
  t193.method("assign", static_cast<G4CutTubs & (G4CutTubs::*)(const G4CutTubs &) >(&G4CutTubs::operator=));
