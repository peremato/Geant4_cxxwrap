...
void add_methods_for_G4CutTubs(jlcxx::Module& types, jlcxx::TypeWrapper<G4CutTubs>& t234) {
  ...
  t234.constructor<const G4String &, G4double, G4double, G4double, G4double, G4double, G4ThreeVector, G4ThreeVector>(/*finalize=*/true);
  ...
  t234.method("GetInnerRadius", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetInnerRadius));
  ...
  t234.method("GetOuterRadius", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetOuterRadius));
  ...
  t234.method("GetZHalfLength", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetZHalfLength));
  ...
  t234.method("GetStartPhiAngle", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetStartPhiAngle));
  ...
  t234.method("GetDeltaPhiAngle", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetDeltaPhiAngle));
  ...
  t234.method("GetSinStartPhi", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetSinStartPhi));
  ...
  t234.method("GetCosStartPhi", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetCosStartPhi));
  ...
  t234.method("GetSinEndPhi", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetSinEndPhi));
  ...
  t234.method("GetCosEndPhi", static_cast<G4double (G4CutTubs::*)()  const>(&G4CutTubs::GetCosEndPhi));
  ...
  t234.method("GetLowNorm", static_cast<G4ThreeVector (G4CutTubs::*)()  const>(&G4CutTubs::GetLowNorm));
  ...
  t234.method("GetHighNorm", static_cast<G4ThreeVector (G4CutTubs::*)()  const>(&G4CutTubs::GetHighNorm));
  ...
  t234.method("SetInnerRadius", static_cast<void (G4CutTubs::*)(G4double) >(&G4CutTubs::SetInnerRadius));
  ...
  t234.method("SetOuterRadius", static_cast<void (G4CutTubs::*)(G4double) >(&G4CutTubs::SetOuterRadius));
  ...
  t234.method("SetZHalfLength", static_cast<void (G4CutTubs::*)(G4double) >(&G4CutTubs::SetZHalfLength));
  ...
  t234.method("SetStartPhiAngle", static_cast<void (G4CutTubs::*)(G4double, G4bool) >(&G4CutTubs::SetStartPhiAngle));
  t234.method("SetStartPhiAngle", [](G4CutTubs& a, G4double arg0)->void{ a.SetStartPhiAngle(arg0); });
  t234.method("SetStartPhiAngle", [](G4CutTubs* a, G4double arg0)->void{ a->SetStartPhiAngle(arg0); });
  ...
  t234.method("SetDeltaPhiAngle", static_cast<void (G4CutTubs::*)(G4double) >(&G4CutTubs::SetDeltaPhiAngle));
  ...
  t234.method("GetCubicVolume", static_cast<G4double (G4CutTubs::*)() >(&G4CutTubs::GetCubicVolume));
  ...
  t234.method("GetSurfaceArea", static_cast<G4double (G4CutTubs::*)() >(&G4CutTubs::GetSurfaceArea));
  ...
  t234.method("BoundingLimits", static_cast<void (G4CutTubs::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4CutTubs::BoundingLimits));
  ...
  t234.method("Inside", static_cast<EInside (G4CutTubs::*)(const G4ThreeVector &)  const>(&G4CutTubs::Inside));
  ...
  t234.method("SurfaceNormal", static_cast<G4ThreeVector (G4CutTubs::*)(const G4ThreeVector &)  const>(&G4CutTubs::SurfaceNormal));
  ...
  t234.method("DistanceToIn", static_cast<G4double (G4CutTubs::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4CutTubs::DistanceToIn));
  ...
  t234.method("DistanceToIn", static_cast<G4double (G4CutTubs::*)(const G4ThreeVector &)  const>(&G4CutTubs::DistanceToIn));
  ...
  t234.method("DistanceToOut", static_cast<G4double (G4CutTubs::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4CutTubs::DistanceToOut));
  t234.method("DistanceToOut", [](G4CutTubs const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t234.method("DistanceToOut", [](G4CutTubs const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t234.method("DistanceToOut", [](G4CutTubs const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t234.method("DistanceToOut", [](G4CutTubs const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t234.method("DistanceToOut", [](G4CutTubs const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t234.method("DistanceToOut", [](G4CutTubs const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t234.method("DistanceToOut", static_cast<G4double (G4CutTubs::*)(const G4ThreeVector &)  const>(&G4CutTubs::DistanceToOut));
  ...
  t234.method("GetEntityType", static_cast<G4GeometryType (G4CutTubs::*)()  const>(&G4CutTubs::GetEntityType));
  ...
  t234.method("GetPointOnSurface", static_cast<G4ThreeVector (G4CutTubs::*)()  const>(&G4CutTubs::GetPointOnSurface));
  ...
  t234.method("Clone", static_cast<G4VSolid * (G4CutTubs::*)()  const>(&G4CutTubs::Clone));
  ...
  t234.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4CutTubs::*)()  const>(&G4CutTubs::CreatePolyhedron));
  ...
  t234.constructor<const G4CutTubs &>(/*finalize=*/true);
  ...
  t234.method("assign", static_cast<G4CutTubs & (G4CutTubs::*)(const G4CutTubs &) >(&G4CutTubs::operator=));
