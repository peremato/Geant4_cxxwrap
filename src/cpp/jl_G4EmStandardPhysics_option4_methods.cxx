...
void add_methods_for_G4EmStandardPhysics_option4(jlcxx::Module& types, jlcxx::TypeWrapper<G4EmStandardPhysics_option4>& t222) {
  ...
  t222.constructor<G4int>(/*finalize=*/true);
  t222.constructor<G4int, const G4String &>(/*finalize=*/true);
  ...
  t222.method("ConstructParticle", static_cast<void (G4EmStandardPhysics_option4::*)() >(&G4EmStandardPhysics_option4::ConstructParticle));
  ...
  t222.method("ConstructProcess", static_cast<void (G4EmStandardPhysics_option4::*)() >(&G4EmStandardPhysics_option4::ConstructProcess));
