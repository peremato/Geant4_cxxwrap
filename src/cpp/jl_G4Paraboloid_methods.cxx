...
void add_methods_for_G4Paraboloid(jlcxx::Module& types, jlcxx::TypeWrapper<G4Paraboloid>& t196) {
  ...
  t196.constructor<const G4String &, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t196.method("GetZHalfLength", static_cast<G4double (G4Paraboloid::*)()  const>(&G4Paraboloid::GetZHalfLength));
  ...
  t196.method("GetRadiusMinusZ", static_cast<G4double (G4Paraboloid::*)()  const>(&G4Paraboloid::GetRadiusMinusZ));
  ...
  t196.method("GetRadiusPlusZ", static_cast<G4double (G4Paraboloid::*)()  const>(&G4Paraboloid::GetRadiusPlusZ));
  ...
  t196.method("GetCubicVolume", static_cast<G4double (G4Paraboloid::*)() >(&G4Paraboloid::GetCubicVolume));
  ...
  t196.method("GetSurfaceArea", static_cast<G4double (G4Paraboloid::*)() >(&G4Paraboloid::GetSurfaceArea));
  ...
  t196.method("CalculateSurfaceArea", static_cast<G4double (G4Paraboloid::*)()  const>(&G4Paraboloid::CalculateSurfaceArea));
  ...
  t196.method("SetZHalfLength", static_cast<void (G4Paraboloid::*)(G4double) >(&G4Paraboloid::SetZHalfLength));
  ...
  t196.method("SetRadiusMinusZ", static_cast<void (G4Paraboloid::*)(G4double) >(&G4Paraboloid::SetRadiusMinusZ));
  ...
  t196.method("SetRadiusPlusZ", static_cast<void (G4Paraboloid::*)(G4double) >(&G4Paraboloid::SetRadiusPlusZ));
  ...
  t196.method("BoundingLimits", static_cast<void (G4Paraboloid::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Paraboloid::BoundingLimits));
  ...
  t196.method("Inside", static_cast<EInside (G4Paraboloid::*)(const G4ThreeVector &)  const>(&G4Paraboloid::Inside));
  ...
  t196.method("SurfaceNormal", static_cast<G4ThreeVector (G4Paraboloid::*)(const G4ThreeVector &)  const>(&G4Paraboloid::SurfaceNormal));
  ...
  t196.method("DistanceToIn", static_cast<G4double (G4Paraboloid::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Paraboloid::DistanceToIn));
  ...
  t196.method("DistanceToIn", static_cast<G4double (G4Paraboloid::*)(const G4ThreeVector &)  const>(&G4Paraboloid::DistanceToIn));
  ...
  t196.method("DistanceToOut", static_cast<G4double (G4Paraboloid::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Paraboloid::DistanceToOut));
  t196.method("DistanceToOut", [](G4Paraboloid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t196.method("DistanceToOut", [](G4Paraboloid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t196.method("DistanceToOut", [](G4Paraboloid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t196.method("DistanceToOut", [](G4Paraboloid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t196.method("DistanceToOut", [](G4Paraboloid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t196.method("DistanceToOut", [](G4Paraboloid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t196.method("DistanceToOut", static_cast<G4double (G4Paraboloid::*)(const G4ThreeVector &)  const>(&G4Paraboloid::DistanceToOut));
  ...
  t196.method("GetEntityType", static_cast<G4GeometryType (G4Paraboloid::*)()  const>(&G4Paraboloid::GetEntityType));
  ...
  t196.method("Clone", static_cast<G4VSolid * (G4Paraboloid::*)()  const>(&G4Paraboloid::Clone));
  ...
  t196.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Paraboloid::*)()  const>(&G4Paraboloid::GetPointOnSurface));
  ...
  t196.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Paraboloid::*)()  const>(&G4Paraboloid::CreatePolyhedron));
  ...
  t196.method("GetPolyhedron", static_cast<G4Polyhedron * (G4Paraboloid::*)()  const>(&G4Paraboloid::GetPolyhedron));
  ...
  t196.constructor<const G4Paraboloid &>(/*finalize=*/true);
  ...
  t196.method("assign", static_cast<G4Paraboloid & (G4Paraboloid::*)(const G4Paraboloid &) >(&G4Paraboloid::operator=));
