...
void add_methods_for_G4Paraboloid(jlcxx::Module& types, jlcxx::TypeWrapper<G4Paraboloid>& t237) {
  ...
  t237.constructor<const G4String &, G4double, G4double, G4double>(/*finalize=*/true);
  ...
  t237.method("GetZHalfLength", static_cast<G4double (G4Paraboloid::*)()  const>(&G4Paraboloid::GetZHalfLength));
  ...
  t237.method("GetRadiusMinusZ", static_cast<G4double (G4Paraboloid::*)()  const>(&G4Paraboloid::GetRadiusMinusZ));
  ...
  t237.method("GetRadiusPlusZ", static_cast<G4double (G4Paraboloid::*)()  const>(&G4Paraboloid::GetRadiusPlusZ));
  ...
  t237.method("GetCubicVolume", static_cast<G4double (G4Paraboloid::*)() >(&G4Paraboloid::GetCubicVolume));
  ...
  t237.method("GetSurfaceArea", static_cast<G4double (G4Paraboloid::*)() >(&G4Paraboloid::GetSurfaceArea));
  ...
  t237.method("CalculateSurfaceArea", static_cast<G4double (G4Paraboloid::*)()  const>(&G4Paraboloid::CalculateSurfaceArea));
  ...
  t237.method("SetZHalfLength", static_cast<void (G4Paraboloid::*)(G4double) >(&G4Paraboloid::SetZHalfLength));
  ...
  t237.method("SetRadiusMinusZ", static_cast<void (G4Paraboloid::*)(G4double) >(&G4Paraboloid::SetRadiusMinusZ));
  ...
  t237.method("SetRadiusPlusZ", static_cast<void (G4Paraboloid::*)(G4double) >(&G4Paraboloid::SetRadiusPlusZ));
  ...
  t237.method("BoundingLimits", static_cast<void (G4Paraboloid::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4Paraboloid::BoundingLimits));
  ...
  t237.method("Inside", static_cast<EInside (G4Paraboloid::*)(const G4ThreeVector &)  const>(&G4Paraboloid::Inside));
  ...
  t237.method("SurfaceNormal", static_cast<G4ThreeVector (G4Paraboloid::*)(const G4ThreeVector &)  const>(&G4Paraboloid::SurfaceNormal));
  ...
  t237.method("DistanceToIn", static_cast<G4double (G4Paraboloid::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4Paraboloid::DistanceToIn));
  ...
  t237.method("DistanceToIn", static_cast<G4double (G4Paraboloid::*)(const G4ThreeVector &)  const>(&G4Paraboloid::DistanceToIn));
  ...
  t237.method("DistanceToOut", static_cast<G4double (G4Paraboloid::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4Paraboloid::DistanceToOut));
  t237.method("DistanceToOut", [](G4Paraboloid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t237.method("DistanceToOut", [](G4Paraboloid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t237.method("DistanceToOut", [](G4Paraboloid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t237.method("DistanceToOut", [](G4Paraboloid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t237.method("DistanceToOut", [](G4Paraboloid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t237.method("DistanceToOut", [](G4Paraboloid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t237.method("DistanceToOut", static_cast<G4double (G4Paraboloid::*)(const G4ThreeVector &)  const>(&G4Paraboloid::DistanceToOut));
  ...
  t237.method("GetEntityType", static_cast<G4GeometryType (G4Paraboloid::*)()  const>(&G4Paraboloid::GetEntityType));
  ...
  t237.method("Clone", static_cast<G4VSolid * (G4Paraboloid::*)()  const>(&G4Paraboloid::Clone));
  ...
  t237.method("GetPointOnSurface", static_cast<G4ThreeVector (G4Paraboloid::*)()  const>(&G4Paraboloid::GetPointOnSurface));
  ...
  t237.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4Paraboloid::*)()  const>(&G4Paraboloid::CreatePolyhedron));
  ...
  t237.method("GetPolyhedron", static_cast<G4Polyhedron * (G4Paraboloid::*)()  const>(&G4Paraboloid::GetPolyhedron));
  ...
  t237.constructor<const G4Paraboloid &>(/*finalize=*/true);
  ...
  t237.method("assign", static_cast<G4Paraboloid & (G4Paraboloid::*)(const G4Paraboloid &) >(&G4Paraboloid::operator=));
