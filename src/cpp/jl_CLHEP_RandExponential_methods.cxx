...
void add_methods_for_CLHEP_RandExponential(jlcxx::Module& types, jlcxx::TypeWrapper<CLHEP::RandExponential>& t129) {
  ...
  t129.constructor<CLHEP::HepRandomEngine &, double>(/*finalize=*/true);
  ...
  t129.method("CLHEP!RandExponential!shoot", static_cast<double (*)() >(&CLHEP::RandExponential::shoot));
  ...
  t129.method("CLHEP!RandExponential!shoot", static_cast<double (*)(double) >(&CLHEP::RandExponential::shoot));
  ...
  t129.method("CLHEP!RandExponential!shootArray", static_cast<void (*)(const int, double *, double) >(&CLHEP::RandExponential::shootArray));
  t129.method("CLHEP!RandExponential!shootArray", [](const int arg0, double * arg1)->void{ CLHEP::RandExponential::shootArray(arg0, arg1); });
  ...
  t129.method("CLHEP!RandExponential!shoot", static_cast<double (*)(CLHEP::HepRandomEngine *) >(&CLHEP::RandExponential::shoot));
  ...
  t129.method("CLHEP!RandExponential!shoot", static_cast<double (*)(CLHEP::HepRandomEngine *, double) >(&CLHEP::RandExponential::shoot));
  ...
  t129.method("CLHEP!RandExponential!shootArray", static_cast<void (*)(CLHEP::HepRandomEngine *, const int, double *, double) >(&CLHEP::RandExponential::shootArray));
  t129.method("CLHEP!RandExponential!shootArray", [](CLHEP::HepRandomEngine * arg0, const int arg1, double * arg2)->void{ CLHEP::RandExponential::shootArray(arg0, arg1, arg2); });
  ...
  t129.method("fire", static_cast<double (CLHEP::RandExponential::*)() >(&CLHEP::RandExponential::fire));
  ...
  t129.method("fire", static_cast<double (CLHEP::RandExponential::*)(double) >(&CLHEP::RandExponential::fire));
  ...
  t129.method("fireArray", static_cast<void (CLHEP::RandExponential::*)(const int, double *) >(&CLHEP::RandExponential::fireArray));
  ...
  t129.method("fireArray", static_cast<void (CLHEP::RandExponential::*)(const int, double *, double) >(&CLHEP::RandExponential::fireArray));
  ...
  t129.method("paren", static_cast<double (CLHEP::RandExponential::*)() >(&CLHEP::RandExponential::operator()));
  ...
  t129.method("paren", static_cast<double (CLHEP::RandExponential::*)(double) >(&CLHEP::RandExponential::operator()));
  ...
  t129.method("engine", static_cast<CLHEP::HepRandomEngine & (CLHEP::RandExponential::*)() >(&CLHEP::RandExponential::engine));
