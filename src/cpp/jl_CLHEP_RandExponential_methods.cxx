...
void add_methods_for_CLHEP_RandExponential(jlcxx::Module& types, jlcxx::TypeWrapper<CLHEP::RandExponential>& t136) {
  ...
  t136.method("CLHEP!RandExponential!shoot", static_cast<double (*)() >(&CLHEP::RandExponential::shoot));
  ...
  t136.method("CLHEP!RandExponential!shoot", static_cast<double (*)(double) >(&CLHEP::RandExponential::shoot));
  ...
  t136.method("CLHEP!RandExponential!shootArray", static_cast<void (*)(const int, double *, double) >(&CLHEP::RandExponential::shootArray));
  t136.method("CLHEP!RandExponential!shootArray", [](const int arg0, double * arg1)->void{ CLHEP::RandExponential::shootArray(arg0, arg1); });
  ...
  t136.method("CLHEP!RandExponential!shoot", static_cast<double (*)(CLHEP::HepRandomEngine *) >(&CLHEP::RandExponential::shoot));
  ...
  t136.method("CLHEP!RandExponential!shoot", static_cast<double (*)(CLHEP::HepRandomEngine *, double) >(&CLHEP::RandExponential::shoot));
  ...
  t136.method("CLHEP!RandExponential!shootArray", static_cast<void (*)(CLHEP::HepRandomEngine *, const int, double *, double) >(&CLHEP::RandExponential::shootArray));
  t136.method("CLHEP!RandExponential!shootArray", [](CLHEP::HepRandomEngine * arg0, const int arg1, double * arg2)->void{ CLHEP::RandExponential::shootArray(arg0, arg1, arg2); });
  ...
  t136.method("fire", static_cast<double (CLHEP::RandExponential::*)() >(&CLHEP::RandExponential::fire));
  ...
  t136.method("fire", static_cast<double (CLHEP::RandExponential::*)(double) >(&CLHEP::RandExponential::fire));
  ...
  t136.method("fireArray", static_cast<void (CLHEP::RandExponential::*)(const int, double *) >(&CLHEP::RandExponential::fireArray));
  ...
  t136.method("fireArray", static_cast<void (CLHEP::RandExponential::*)(const int, double *, double) >(&CLHEP::RandExponential::fireArray));
  ...
  t136.method("paren", static_cast<double (CLHEP::RandExponential::*)() >(&CLHEP::RandExponential::operator()));
  ...
  t136.method("paren", static_cast<double (CLHEP::RandExponential::*)(double) >(&CLHEP::RandExponential::operator()));
  ...
  t136.method("engine", static_cast<CLHEP::HepRandomEngine & (CLHEP::RandExponential::*)() >(&CLHEP::RandExponential::engine));
