...
void add_methods_for_G4JLSteppingAction(jlcxx::Module& types, jlcxx::TypeWrapper<G4JLSteppingAction>& t113) {
  ...
  t113.constructor<stepaction_f, void *>(/*finalize=*/true);
  ...
  t113.method("UserSteppingAction", static_cast<void (G4JLSteppingAction::*)(const G4Step *) >(&G4JLSteppingAction::UserSteppingAction));
