...
void add_methods_for_G4UnionSolid(jlcxx::Module& types, jlcxx::TypeWrapper<G4UnionSolid>& t236) {
  ...
  t236.constructor<const G4String &, G4VSolid *, G4VSolid *>(/*finalize=*/true);
  ...
  t236.constructor<const G4String &, G4VSolid *, G4VSolid *, G4RotationMatrix *, const G4ThreeVector &>(/*finalize=*/true);
  ...
  t236.constructor<const G4String &, G4VSolid *, G4VSolid *, const G4Transform3D &>(/*finalize=*/true);
  ...
  t236.method("GetEntityType", static_cast<G4GeometryType (G4UnionSolid::*)()  const>(&G4UnionSolid::GetEntityType));
  ...
  t236.method("Clone", static_cast<G4VSolid * (G4UnionSolid::*)()  const>(&G4UnionSolid::Clone));
  ...
  t236.constructor<const G4UnionSolid &>(/*finalize=*/true);
  ...
  t236.method("assign", static_cast<G4UnionSolid & (G4UnionSolid::*)(const G4UnionSolid &) >(&G4UnionSolid::operator=));
  ...
  t236.method("BoundingLimits", static_cast<void (G4UnionSolid::*)(G4ThreeVector &, G4ThreeVector &)  const>(&G4UnionSolid::BoundingLimits));
  ...
  t236.method("Inside", static_cast<EInside (G4UnionSolid::*)(const G4ThreeVector &)  const>(&G4UnionSolid::Inside));
  ...
  t236.method("SurfaceNormal", static_cast<G4ThreeVector (G4UnionSolid::*)(const G4ThreeVector &)  const>(&G4UnionSolid::SurfaceNormal));
  ...
  t236.method("DistanceToIn", static_cast<G4double (G4UnionSolid::*)(const G4ThreeVector &, const G4ThreeVector &)  const>(&G4UnionSolid::DistanceToIn));
  ...
  t236.method("DistanceToIn", static_cast<G4double (G4UnionSolid::*)(const G4ThreeVector &)  const>(&G4UnionSolid::DistanceToIn));
  ...
  t236.method("DistanceToOut", static_cast<G4double (G4UnionSolid::*)(const G4ThreeVector &, const G4ThreeVector &, const G4bool, G4bool *, G4ThreeVector *)  const>(&G4UnionSolid::DistanceToOut));
  t236.method("DistanceToOut", [](G4UnionSolid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a.DistanceToOut(arg0, arg1); });
  t236.method("DistanceToOut", [](G4UnionSolid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a.DistanceToOut(arg0, arg1, arg2); });
  t236.method("DistanceToOut", [](G4UnionSolid const& a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a.DistanceToOut(arg0, arg1, arg2, arg3); });
  t236.method("DistanceToOut", [](G4UnionSolid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1)->G4double{ return a->DistanceToOut(arg0, arg1); });
  t236.method("DistanceToOut", [](G4UnionSolid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2)->G4double{ return a->DistanceToOut(arg0, arg1, arg2); });
  t236.method("DistanceToOut", [](G4UnionSolid const* a, const G4ThreeVector & arg0, const G4ThreeVector & arg1, const G4bool arg2, G4bool * arg3)->G4double{ return a->DistanceToOut(arg0, arg1, arg2, arg3); });
  ...
  t236.method("DistanceToOut", static_cast<G4double (G4UnionSolid::*)(const G4ThreeVector &)  const>(&G4UnionSolid::DistanceToOut));
  ...
  t236.method("ComputeDimensions", static_cast<void (G4UnionSolid::*)(G4VPVParameterisation *, const G4int, const G4VPhysicalVolume *) >(&G4UnionSolid::ComputeDimensions));
  ...
  t236.method("CreatePolyhedron", static_cast<G4Polyhedron * (G4UnionSolid::*)()  const>(&G4UnionSolid::CreatePolyhedron));
  ...
  t236.method("GetCubicVolume", static_cast<G4double (G4UnionSolid::*)() >(&G4UnionSolid::GetCubicVolume));
