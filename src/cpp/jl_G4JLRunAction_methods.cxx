...
void add_methods_for_G4JLRunAction(jlcxx::Module& types, jlcxx::TypeWrapper<G4JLRunAction>& t114) {
  ...
  t114.constructor<runaction_f>(/*finalize=*/false);
  t114.constructor<runaction_f, void *>(/*finalize=*/false);
  t114.constructor<runaction_f, void *, runaction_f>(/*finalize=*/false);
  t114.constructor<runaction_f, void *, runaction_f, void *>(/*finalize=*/false);
  ...
  t114.method("BeginOfRunAction", static_cast<void (G4JLRunAction::*)(const G4Run *) >(&G4JLRunAction::BeginOfRunAction));
  ...
  t114.method("EndOfRunAction", static_cast<void (G4JLRunAction::*)(const G4Run *) >(&G4JLRunAction::EndOfRunAction));
