...
void add_methods_for_G4Run(jlcxx::Module& types, jlcxx::TypeWrapper<G4Run>& t116) {
  ...
  t116.method("RecordEvent", static_cast<void (G4Run::*)(const G4Event *) >(&G4Run::RecordEvent));
  ...
  t116.method("Merge", static_cast<void (G4Run::*)(const G4Run *) >(&G4Run::Merge));
  ...
  t116.method("StoreEvent", static_cast<void (G4Run::*)(G4Event *) >(&G4Run::StoreEvent));
  ...
  t116.method("GetRunID", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetRunID));
  ...
  t116.method("GetNumberOfEvent", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetNumberOfEvent));
  ...
  t116.method("GetNumberOfEventToBeProcessed", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetNumberOfEventToBeProcessed));
  ...
  t116.method("GetHCtable", static_cast<const G4HCtable * (G4Run::*)()  const>(&G4Run::GetHCtable));
  ...
  t116.method("GetRandomNumberStatus", static_cast<const G4String & (G4Run::*)()  const>(&G4Run::GetRandomNumberStatus));
  ...
  t116.method("SetRunID", static_cast<void (G4Run::*)(G4int) >(&G4Run::SetRunID));
  ...
  t116.method("SetNumberOfEventToBeProcessed", static_cast<void (G4Run::*)(G4int) >(&G4Run::SetNumberOfEventToBeProcessed));
  ...
  t116.method("SetHCtable", static_cast<void (G4Run::*)(G4HCtable *) >(&G4Run::SetHCtable));
  ...
  t116.method("SetRandomNumberStatus", static_cast<void (G4Run::*)(G4String &) >(&G4Run::SetRandomNumberStatus));
