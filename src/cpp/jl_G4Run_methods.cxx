...
void add_methods_for_G4Run(jlcxx::Module& types, jlcxx::TypeWrapper<G4Run>& t119) {
  ...
  t119.method("RecordEvent", static_cast<void (G4Run::*)(const G4Event *) >(&G4Run::RecordEvent));
  ...
  t119.method("Merge", static_cast<void (G4Run::*)(const G4Run *) >(&G4Run::Merge));
  ...
  t119.method("StoreEvent", static_cast<void (G4Run::*)(G4Event *) >(&G4Run::StoreEvent));
  ...
  t119.method("GetRunID", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetRunID));
  ...
  t119.method("GetNumberOfEvent", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetNumberOfEvent));
  ...
  t119.method("GetNumberOfEventToBeProcessed", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetNumberOfEventToBeProcessed));
  ...
  t119.method("GetHCtable", static_cast<const G4HCtable * (G4Run::*)()  const>(&G4Run::GetHCtable));
  ...
  t119.method("GetRandomNumberStatus", static_cast<const G4String & (G4Run::*)()  const>(&G4Run::GetRandomNumberStatus));
  ...
  t119.method("SetRunID", static_cast<void (G4Run::*)(G4int) >(&G4Run::SetRunID));
  ...
  t119.method("SetNumberOfEventToBeProcessed", static_cast<void (G4Run::*)(G4int) >(&G4Run::SetNumberOfEventToBeProcessed));
  ...
  t119.method("SetHCtable", static_cast<void (G4Run::*)(G4HCtable *) >(&G4Run::SetHCtable));
  ...
  t119.method("SetRandomNumberStatus", static_cast<void (G4Run::*)(G4String &) >(&G4Run::SetRandomNumberStatus));
