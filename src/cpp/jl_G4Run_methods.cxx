...
void add_methods_for_G4Run(jlcxx::Module& types, jlcxx::TypeWrapper<G4Run>& t115) {
  ...
  t115.method("RecordEvent", static_cast<void (G4Run::*)(const G4Event *) >(&G4Run::RecordEvent));
  ...
  t115.method("Merge", static_cast<void (G4Run::*)(const G4Run *) >(&G4Run::Merge));
  ...
  t115.method("StoreEvent", static_cast<void (G4Run::*)(G4Event *) >(&G4Run::StoreEvent));
  ...
  t115.method("GetRunID", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetRunID));
  ...
  t115.method("GetNumberOfEvent", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetNumberOfEvent));
  ...
  t115.method("GetNumberOfEventToBeProcessed", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetNumberOfEventToBeProcessed));
  ...
  t115.method("GetHCtable", static_cast<const G4HCtable * (G4Run::*)()  const>(&G4Run::GetHCtable));
  ...
  t115.method("GetRandomNumberStatus", static_cast<const G4String & (G4Run::*)()  const>(&G4Run::GetRandomNumberStatus));
  ...
  t115.method("SetRunID", static_cast<void (G4Run::*)(G4int) >(&G4Run::SetRunID));
  ...
  t115.method("SetNumberOfEventToBeProcessed", static_cast<void (G4Run::*)(G4int) >(&G4Run::SetNumberOfEventToBeProcessed));
  ...
  t115.method("SetHCtable", static_cast<void (G4Run::*)(G4HCtable *) >(&G4Run::SetHCtable));
  ...
  t115.method("SetRandomNumberStatus", static_cast<void (G4Run::*)(G4String &) >(&G4Run::SetRandomNumberStatus));
