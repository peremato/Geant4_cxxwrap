...
void add_methods_for_G4Run(jlcxx::Module& types, jlcxx::TypeWrapper<G4Run>& t117) {
  ...
  t117.method("RecordEvent", static_cast<void (G4Run::*)(const G4Event *) >(&G4Run::RecordEvent));
  ...
  t117.method("Merge", static_cast<void (G4Run::*)(const G4Run *) >(&G4Run::Merge));
  ...
  t117.method("StoreEvent", static_cast<void (G4Run::*)(G4Event *) >(&G4Run::StoreEvent));
  ...
  t117.method("GetRunID", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetRunID));
  ...
  t117.method("GetNumberOfEvent", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetNumberOfEvent));
  ...
  t117.method("GetNumberOfEventToBeProcessed", static_cast<G4int (G4Run::*)()  const>(&G4Run::GetNumberOfEventToBeProcessed));
  ...
  t117.method("GetHCtable", static_cast<const G4HCtable * (G4Run::*)()  const>(&G4Run::GetHCtable));
  ...
  t117.method("GetRandomNumberStatus", static_cast<const G4String & (G4Run::*)()  const>(&G4Run::GetRandomNumberStatus));
  ...
  t117.method("SetRunID", static_cast<void (G4Run::*)(G4int) >(&G4Run::SetRunID));
  ...
  t117.method("SetNumberOfEventToBeProcessed", static_cast<void (G4Run::*)(G4int) >(&G4Run::SetNumberOfEventToBeProcessed));
  ...
  t117.method("SetHCtable", static_cast<void (G4Run::*)(G4HCtable *) >(&G4Run::SetHCtable));
  ...
  t117.method("SetRandomNumberStatus", static_cast<void (G4Run::*)(G4String &) >(&G4Run::SetRandomNumberStatus));
