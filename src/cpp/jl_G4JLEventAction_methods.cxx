...
void add_methods_for_G4JLEventAction(jlcxx::Module& types, jlcxx::TypeWrapper<G4JLEventAction>& t116) {
  ...
  t116.constructor<eventaction_f>(/*finalize=*/true);
  t116.constructor<eventaction_f, void *>(/*finalize=*/true);
  t116.constructor<eventaction_f, void *, eventaction_f>(/*finalize=*/true);
  t116.constructor<eventaction_f, void *, eventaction_f, void *>(/*finalize=*/true);
  ...
  t116.method("BeginOfEventAction", static_cast<void (G4JLEventAction::*)(const G4Event *) >(&G4JLEventAction::BeginOfEventAction));
  ...
  t116.method("EndOfEventAction", static_cast<void (G4JLEventAction::*)(const G4Event *) >(&G4JLEventAction::EndOfEventAction));
