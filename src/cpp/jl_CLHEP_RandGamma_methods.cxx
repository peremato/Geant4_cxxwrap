...
void add_methods_for_CLHEP_RandGamma(jlcxx::Module& types, jlcxx::TypeWrapper<CLHEP::RandGamma>& t138) {
  ...
  t138.constructor<CLHEP::HepRandomEngine &>(/*finalize=*/true);
  t138.constructor<CLHEP::HepRandomEngine &, double>(/*finalize=*/true);
  t138.constructor<CLHEP::HepRandomEngine &, double, double>(/*finalize=*/true);
  ...
  t138.method("CLHEP!RandGamma!shoot", static_cast<double (*)() >(&CLHEP::RandGamma::shoot));
  ...
  t138.method("CLHEP!RandGamma!shoot", static_cast<double (*)(double, double) >(&CLHEP::RandGamma::shoot));
  ...
  t138.method("CLHEP!RandGamma!shootArray", static_cast<void (*)(const int, double *, double, double) >(&CLHEP::RandGamma::shootArray));
  t138.method("CLHEP!RandGamma!shootArray", [](const int arg0, double * arg1)->void{ CLHEP::RandGamma::shootArray(arg0, arg1); });
  t138.method("CLHEP!RandGamma!shootArray", [](const int arg0, double * arg1, double arg2)->void{ CLHEP::RandGamma::shootArray(arg0, arg1, arg2); });
  ...
  t138.method("CLHEP!RandGamma!shoot", static_cast<double (*)(CLHEP::HepRandomEngine *) >(&CLHEP::RandGamma::shoot));
  ...
  t138.method("CLHEP!RandGamma!shoot", static_cast<double (*)(CLHEP::HepRandomEngine *, double, double) >(&CLHEP::RandGamma::shoot));
  ...
  t138.method("CLHEP!RandGamma!shootArray", static_cast<void (*)(CLHEP::HepRandomEngine *, const int, double *, double, double) >(&CLHEP::RandGamma::shootArray));
  t138.method("CLHEP!RandGamma!shootArray", [](CLHEP::HepRandomEngine * arg0, const int arg1, double * arg2)->void{ CLHEP::RandGamma::shootArray(arg0, arg1, arg2); });
  t138.method("CLHEP!RandGamma!shootArray", [](CLHEP::HepRandomEngine * arg0, const int arg1, double * arg2, double arg3)->void{ CLHEP::RandGamma::shootArray(arg0, arg1, arg2, arg3); });
  ...
  t138.method("fire", static_cast<double (CLHEP::RandGamma::*)() >(&CLHEP::RandGamma::fire));
  ...
  t138.method("fire", static_cast<double (CLHEP::RandGamma::*)(double, double) >(&CLHEP::RandGamma::fire));
  ...
  t138.method("fireArray", static_cast<void (CLHEP::RandGamma::*)(const int, double *) >(&CLHEP::RandGamma::fireArray));
  ...
  t138.method("fireArray", static_cast<void (CLHEP::RandGamma::*)(const int, double *, double, double) >(&CLHEP::RandGamma::fireArray));
  ...
  t138.method("paren", static_cast<double (CLHEP::RandGamma::*)() >(&CLHEP::RandGamma::operator()));
  ...
  t138.method("paren", static_cast<double (CLHEP::RandGamma::*)(double, double) >(&CLHEP::RandGamma::operator()));
  ...
  t138.method("engine", static_cast<CLHEP::HepRandomEngine & (CLHEP::RandGamma::*)() >(&CLHEP::RandGamma::engine));
